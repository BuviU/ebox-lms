/*
jQuery( function() {
	if ( ( jQuery( 'body.wp-admin.post-type-ebox-quiz form#posts-filter' ).length ) || ( jQuery( 'body.wp-admin.post-type-ebox-topic form#posts-filter' ).length ) || ( jQuery( 'body.wp-admin.post-type-ebox-essays form#posts-filter' ).length ) || ( jQuery( 'body.wp-admin.post-type-ebox-assignment form#posts-filter' ).length ) ) {
		...
		if ( ( jQuery( 'form#posts-filter select#course_id' ).length ) && ( jQuery( 'form#posts-filter select#lesson_id' ).length ) ) {
			...
			if ( jQuery( 'body.wp-admin.post-type-ebox-essays form#posts-filter' ).length ) {
			...
			jQuery( 'form#posts-filter select#course_id' ).on( 'change', function(e) {
				...
				if ( jQuery( 'body.wp-admin.post-type-ebox-topic form#posts-filter' ).length ) {
...
if (typeof ebox_data.json !== "undefined") {
...
function ebox_do_condshow_match(index, value) {
...
function ebox_add_condshow_handlers(index, value) {
  if (typeof value !== "undefined") {
    jQuery.each(value, function (subopt, setting) {
      // cspell:disable-line
      jQuery("[name=" + subopt + "]").change(function () {
        // cspell:disable-line
        ebox_do_condshow_match(index, value);
      });
    });
  }
}

function ebox_do_condshow(condshow) {
  if (typeof ebox_data.condshow !== "undefined") {
    jQuery.each(ebox_data.condshow, function (index, value) {
      ebox_do_condshow_match(index, value);
      ebox_add_condshow_handlers(index, value);
    });
  }
}

function ebox_show_pointer(handle, value) {
  if (typeof jQuery(value.pointer_target).pointer !== "undefined") {
    jQuery(value.pointer_target)
      .pointer({
...
*/
jQuery(function () {
  if (typeof ebox_data.pointers !== "undefined") {
    jQuery.each(ebox_data.pointers, function (index, value) {
      if (value !== "undefined" && value.pointer_text != "") {
        ebox_show_pointer(index, value);
      }
    });
  }
  ...
  jQuery(".ebox_header_tabs a").on("click", function () {
    ...
    jQuery(".ebox_header_tab[href!=#" + string_ref + "]").removeClass("active");
    jQuery(".ebox_header_tab#[href=#" + string_ref + "]").addClass("active");
    return false;
  });
  ...
  if (jQuery(".ebox-modules_settings").length) {
    ebox_lesson_edit_page_javascript();
  }

  if (jQuery(".ebox-courses_settings").length) {
    ebox_course_edit_page_javascript();
  }

  if (jQuery(".ebox-topic_settings").length) {
  ...
  if (
    ...
    ebox_assignment_edit_page_javascript();
  }

  if (jQuery(".ebox-quiz_settings").length) {
...
function ebox_lesson_edit_page_javascript() {
  jQuery("input[name='ebox-modules_lesson_assignment_upload']").on(
    ...
    function () {
      ...
      if (checked) {
        ...
        jQuery("#ebox-modules_lesson_assignment_points_enabled").slideDown();

        jQuery("#ebox-modules_assignment_upload_limit_extensions").slideDown();
        jQuery("#ebox-modules_assignment_upload_limit_size").slideDown();

        //jQuery("#ebox-modules_lesson_assignment_points_amount").show();
        jQuery(
        ...
        if (jQuery("input[name='ebox-modules_lesson_video_enabled']").length) {
        ...
        jQuery("#ebox-modules_lesson_assignment_deletion_enabled").slideDown();
      } else {
        jQuery("#ebox-modules_auto_approve_assignment").slideUp();
        jQuery("#ebox-modules_lesson_assignment_points_enabled").slideUp();
        jQuery("#ebox-modules_assignment_upload_limit_extensions").slideUp();
        jQuery("#ebox-modules_assignment_upload_limit_size").slideUp();
        jQuery("#ebox-modules_lesson_assignment_deletion_enabled").slideUp();
        ...
        //jQuery("#ebox-modules_lesson_assignment_points_amount").hide();
        jQuery(
          "input[name='ebox-modules_lesson_assignment_points_enabled']"
        ).change();
      ...
      if (jQuery("[name='ebox-modules_auto_approve_assignment']").length) {
        jQuery("[name='ebox-modules_auto_approve_assignment']").change();
      }
    }
  );

  if (jQuery("input[name='ebox-modules_lesson_assignment_upload']").length) {
  ...
  jQuery("[name='ebox-modules_lesson_assignment_points_enabled']").on(
    ...
    function () {
      ...
      if (checked) {
        jQuery("#ebox-modules_lesson_assignment_points_amount").slideDown();
      } else {
        jQuery("#ebox-modules_lesson_assignment_points_amount").slideUp();

        // Clear out the Points amount value
        jQuery("[name='ebox-modules_lesson_assignment_points_amount']").val(
          "0"
        );
      }
    }
  ...
  if (jQuery("[name='ebox-modules_lesson_assignment_points_enabled']").length) {
    ...
    function () {
      ...
      if (checked) {
        ...
        if (checked) {
          ...
          jQuery("#ebox-modules_assignment_upload_limit_count").slideDown();
          jQuery(
      ...
      function () {
        ...
        if (video_enabled_checked) {
          ...
          if (
            ...
            jQuery("input[name='ebox-modules_lesson_assignment_upload']").attr(
              "checked",
              false
            );
        ...
        if (jQuery("select[name='ebox-modules_lesson_video_shown']").length) {
  ...
  if (jQuery("select[name='ebox-modules_lesson_video_shown']").length) {
    jQuery("select[name='ebox-modules_lesson_video_shown']").on(
      "change",
      function () {
        video_shown_checked = jQuery(
          "input[name=ebox-modules_lesson_video_enabled]:checked"
        ).length;
        video_shown_selected = jQuery(
  ...
  if (jQuery("input[name='ebox-modules_lesson_video_auto_complete']").length) {
    jQuery("input[name='ebox-modules_lesson_video_auto_complete']").on(
      "change",
      function () {
        video_auto_complete_checked = jQuery(
        ...
        if (
          video_enabled_checked &&
          video_shown_selected == "AFTER" &&
          video_auto_complete_checked
        ) {
          jQuery("#ebox-modules_lesson_video_auto_complete_delay").slideDown();
          jQuery("#ebox-modules_lesson_video_hide_complete_button").slideDown();
        } else {
          jQuery("#ebox-modules_lesson_video_auto_complete_delay").hide();
          jQuery("#ebox-modules_lesson_video_hide_complete_button").hide();
        }
      }
    );
  ...
  jQuery("input[name='ebox-modules_visible_after']").on("blur", function () {
    var visible_after = jQuery(
      "input[name='ebox-modules_visible_after']"
    ).val();
    ...
    if (Math.abs(visible_after) > 0) {
      ...
      //jQuery("input[name='ebox-modules_visible_after']").val('0');

      jQuery("#ebox-modules_visible_after_specific_date input").removeAttr(
        "disabled"
      );
      jQuery("#ebox-modules_visible_after_specific_date select").removeAttr(
        "disabled"
      );
    }
  });

  if (jQuery("input[name='ebox-modules_visible_after']").length) {
  ...
  jQuery("#ebox-modules_visible_after_specific_date .ld_date_selector").on(
    "change",
    function () {
      var visible_specific_mm = jQuery(
      ...
      var visible_specific_aa = jQuery(
      ...
      var visible_specific_hh = jQuery(
      ...
      var visible_specific_mn = jQuery(
  ...
  if (
    jQuery("#ebox-modules_visible_after_specific_date .ld_date_selector").length
  ) {
    jQuery(
...
//		jQuery('#ui-datepicker-div').addClass('ebox-datepicker');
//	}
//});

//jQuery( "input[name='ebox-modules_visible_after_specific_date']" ).datepicker({
//	changeMonth: true,
//	changeYear: true,
//    dateFormat : 'yy-mm-dd', //'MM d, yy',
//    onSelect: function(dateText, inst) {
//		jQuery("input[name='ebox-modules_visible_after']").val('0');
//		jQuery("input[name='ebox-modules_visible_after']").prop('disabled', true);
//	}
//});

//    jQuery("input[name='ebox-modules_visible_after_specific_date']").blur(function() {
//		var specific_data = jQuery("input[name='ebox-modules_visible_after_specific_date']").val();
//		if( specific_data != '') {
//			jQuery("input[name='ebox-modules_visible_after']").val('0');
//			jQuery("input[name='ebox-modules_visible_after']").attr("disabled", "disabled");
//		} else {
//			jQuery("input[name='ebox-modules_visible_after']").removeAttr("disabled");
//		}
//    });

//	jQuery("input[name='ebox-modules_visible_after']").on( 'click', function() {
//		var specific_data = jQuery("input[name='ebox-modules_visible_after_specific_date']").val();
//		if( specific_data != '') {
//			jQuery("input[name='ebox-modules_visible_after']").val('0');
//			jQuery("input[name='ebox-modules_visible_after']").attr("disabled", "disabled");
...
function ebox_course_edit_page_javascript() {
  jQuery("select[name=ebox-courses_course_price_type]").on(
    "change",
    function () {
      var price_type = jQuery(
        "select[name=ebox-courses_course_price_type]"
      ).val();
      ...
      if (price_type == "subscribe") {
        ...
        /*jQuery("#ebox-courses_course_no_of_cycles").show();
			jQuery("#ebox-courses_course_remove_access_on_subscription_end").show();*/
      } else {
        jQuery("#ebox-courses_course_price_billing_cycle").hide();
        /*jQuery("#ebox-courses_course_no_of_cycles").hide();
			jQuery("#ebox-courses_course_remove_access_on_subscription_end").hide(); */
      }
    }
  );
  ...
  jQuery("input[name=ebox-courses_expire_access]").on("change", function () {
    if (
      jQuery("input[name=ebox-courses_expire_access]:checked").val() ==
      undefined
    ) {
      ...
      jQuery("#ebox-courses_expire_access_delete_progress").slideDown("slow");
    }
  });
  ...
  jQuery("select[name=ebox-courses_course_lesson_per_page]").on(
    ...
    function () {
      if (
        ...
        jQuery("#ebox-courses_course_lesson_per_page_custom").slideDown("slow");
      }
    }
  );
  ...
  jQuery("input[name=ebox-courses_course_prerequisite_enabled]").on(
    ...
    function () {
      if (
        ...
        jQuery("#ebox-courses_course_prerequisite_compare").slideDown("slow");
      }
    }
  );
  ...
  jQuery("input[name=ebox-courses_course_points_enabled]").on(
    ...
    function () {
      if (
        jQuery(
          "input[name=ebox-courses_course_points_enabled]:checked"
        ).val() == undefined
      ) {
...
function ebox_quiz_edit_page_javascript() {
  jQuery("select[name=ebox-quiz_quiz_pro]").on("change", function () {
    var quiz_pro = jQuery("select[name=ebox-quiz_quiz_pro]").val();
    if (window["ebox-quiz_quiz_pro"] != quiz_pro) {
      var html = jQuery("#ebox-quiz_quiz_pro_html").html();
      if (typeof html !== "undefined" && html.length > 10) {
        window["ebox-quiz_quiz_pro_html"] = html;
      }
    } else {
      jQuery("#ebox-quiz_quiz_pro_html").show();
    ...
    if (quiz_pro > 0) {
      jQuery("#advanced_quiz_preview").attr(
        "href",
        ebox_data.advanced_quiz_preview_link + quiz_pro
      );
    } else {
  ...
  jQuery("select[name=ebox-quiz_course]").on("change", function () {
    if (window.ebox_quiz_lesson == undefined) {
      window.ebox_quiz_lesson = jQuery("select[name=ebox-quiz_lesson]").val();
    }
    ...
    jQuery.post(
      ...
      function (json) {
        ...
        //jQuery("select[name=ebox-topic_lesson]").val(window['ebox_topic_lesson']);
      },
      "json"
    );
  });
  //jQuery("#postimagediv").addClass("hidden_by_ebox_lms_ebox_module.js"); // cspell:disable-line
...
function ebox_assignment_edit_page_javascript() {
  jQuery("select[name=ebox-assignment_course]").on("change", function () {
    if (window["ebox-assignment_lesson"] == undefined) {
    ...
    jQuery.post(
      ...
      function (json) {
        window.response = json;
        html =
          '<option value="0">' + ebox_data.select_a_lesson_lang + "</option>";
        jQuery.each(json.opt, function (i, opt) {
          if (opt.key != "" && opt.key != "0") {
            selected =
              opt.key == window["ebox-assignment_lesson"]
                ? "selected=selected"
                : "";
            html +=
              "<option value='" +
...
function ebox_topic_edit_page_javascript() {
  jQuery('[name="ebox-topic_lesson_assignment_upload"]').on(
    ...
    function () {
      ...
      if (checked) {
        ...
        jQuery("#ebox-topic_assignment_upload_limit_extensions").slideDown();
        jQuery("#ebox-topic_assignment_upload_limit_size").slideDown();

        // We uncheck the Video Progression option because we don't support Assignments and Videos
        if (jQuery("input[name='ebox-topic_lesson_video_enabled']").length) {
      ...
      if (jQuery("[name='ebox-topic_auto_approve_assignment']").length) {
        jQuery("[name='ebox-topic_auto_approve_assignment']").change();
      }
    }
  );

  if (jQuery("[name='ebox-topic_lesson_assignment_upload']").length) {
  ...
  jQuery('[name="ebox-topic_lesson_assignment_points_enabled"]').on(
    ...
    function () {
      ...
      if (checked) {
        ...
        // Clear out the Points amount value
        jQuery("[name='ebox-topic_lesson_assignment_points_amount']").val("0");
      }
    }
  );

  if (jQuery("[name='ebox-topic_lesson_assignment_points_enabled']").length) {
    jQuery("[name='ebox-topic_lesson_assignment_points_enabled']").change();
  }
  ...
  jQuery('[name="ebox-topic_auto_approve_assignment"]').on(
    ...
    function () {
      ...
      if (checked) {
        ...
        if (checked) {
          jQuery("#ebox-topic_assignment_upload_limit_count").slideUp();
          jQuery("#ebox-topic_lesson_assignment_deletion_enabled").slideUp();
        } else {
          jQuery("#ebox-topic_assignment_upload_limit_count").slideDown();
          jQuery("#ebox-topic_lesson_assignment_deletion_enabled").slideDown();
        }
      } else {
        jQuery("#ebox-topic_assignment_upload_limit_count").slideUp();
        jQuery("#ebox-topic_lesson_assignment_deletion_enabled").slideUp();
    ...
    jQuery("input[name='ebox-topic_lesson_video_enabled']").on(
      ...
      function () {
        ...
        if (video_enabled_checked) {
          ...
          if (
            jQuery("input[name='ebox-topic_lesson_assignment_upload']").length
          ) {
        ...
        if (jQuery("select[name='ebox-topic_lesson_video_shown']").length) {
  ...
  if (jQuery("select[name='ebox-topic_lesson_video_shown']").length) {
    jQuery("select[name='ebox-topic_lesson_video_shown']").on(
      ...
      function () {
        ...
        video_shown_selected = jQuery(
          "select[name='ebox-topic_lesson_video_shown']"
        ).val();
  ...
  if (jQuery("input[name='ebox-topic_lesson_video_auto_complete']").length) {
    jQuery("input[name='ebox-topic_lesson_video_auto_complete']").on(
      ...
      function () {
        ...
        if (
          ...
          jQuery("#ebox-topic_lesson_video_auto_complete_delay").slideDown();
          jQuery("#ebox-topic_lesson_video_hide_complete_button").slideDown();
        } else {
          jQuery("#ebox-topic_lesson_video_auto_complete_delay").hide();
  ...
  jQuery("select[name=ebox-topic_course]").on("change", function () {
    if (window.ebox_topic_lesson == undefined) {
      window.ebox_topic_lesson = jQuery("select[name=ebox-topic_lesson]").val();
    }
    ...
    /*
		jQuery.post(ajaxurl, data, function(json) {
			...
			jQuery.each(json, function(key, value) {
				if(key != '' && key != '0')
				{
					selected = (key == window['ebox_topic_lesson'])? 'selected=selected': '';
...
// The following functions are also found in /templates/ebox_template_script.js but as that is a template and the admin
...
if (typeof flip_expand_collapse === "undefined") {
  function flip_expand_collapse(what, id) {
    if (jQuery(what + "-" + id + " .list_arrow.flippable").hasClass("expand")) {
      ...
      jQuery(what + "-" + id + " .list_arrow.flippable").removeClass(
        "collapse"
      );
...
jQuery(function () {
  jQuery("select[ebox_lazy_load_data]").each(function () {
    ...
    var load_data = jQuery(load_el).attr("ebox_lazy_load_data");
    if (typeof load_data !== "undefined" && load_data != "") {
      load_data = JSON.parse(load_data);
      ebox_element_lazy_loader(load_el, load_data);
    }
  });
});

function ebox_element_lazy_loader(load_el, query_data) {
  var spinner_el = jQuery(load_el).siblings("span.ebox_lazy_loading");
  ...
  var post_data = {
    action: "ebox_element_lazy_loader",
          ...
          if (reply_data.html_options != "") {
            ...
            if (typeof reply_data.query_data !== "undefined") {
              if (reply_data.query_data != "") {
                ebox_element_lazy_loader(load_el, reply_data.query_data);
              }
            }
          } else {
...
function update_user_course_progess_input(type, user_course_data, action) {
  ...
  // Must have User ID
  if (
    typeof user_course_data.user_id !== "undefined" &&
  ...
  // Must have Course ID
  if (
    typeof user_course_data.course_id !== "undefined" &&
  ...
  if (type == "quiz") {
    // Must have Quiz ID
    if (
      typeof user_course_data.quiz_id !== "undefined" &&
      user_course_data.quiz_id != ""
    ) {
      var quiz_id = user_course_data.quiz_id;

      if (
        typeof user_progress.quiz[course_id] === "undefined" ||
        user_progress.quiz[course_id] == null
      ) {
    ...
    if (type == "topic") {
      if (
        typeof user_course_data.topic_id !== "undefined" &&
        user_course_data.topic_id != ""
      ) {
        var topic_id = user_course_data.topic_id;

        // Must have Lesson ID
        if (
          typeof user_course_data.lesson_id !== "undefined" &&
          user_course_data.lesson_id != ""
        ) {
        ...
        if (action == true) {
          if (
            typeof user_progress.course[course_id] === "undefined" ||
            user_progress.course[course_id] == null
          ) {
            user_progress.course[course_id] = {};
          }

          if (
            typeof user_progress.course[course_id].topics === "undefined" ||
            user_progress.course[course_id].topics == null
          ) {
            user_progress.course[course_id].topics = {};
          }

          if (
            typeof user_progress.course[course_id].topics[lesson_id] ===
              "undefined" ||
            user_progress.course[course_id].topics[lesson_id] == null
          ) {
          ...
          typeof user_progress.course[course_id].topics[lesson_id][topic_id] !==
          "undefined"
        ) {
          ...
          if (
            Object.keys(user_progress.course[course_id].topics[lesson_id])
              .length === 0
          ) {
      ...
      if (action == true) {
        ...
        if (
          typeof user_progress.course[course_id].modules === "undefined" ||
          user_progress.course[course_id].modules == null
        ) {
          user_progress.course[course_id].modules = {};
        }

        //if ( typeof user_course_progress[course_id]['modules'][lesson_id] === 'undefined' )
        //	user_course_progress[course_id]['modules'][lesson_id] = {};

        user_progress.course[course_id].modules[lesson_id] = 1;
      } else if (
        typeof user_progress.course[course_id].modules[lesson_id] !==
        "undefined"
      ) {
        delete user_progress.course[course_id].modules[lesson_id];
      }
    }
  }
...
function get_course_data(course_id) {
  ...
  if (jQuery("#ebox-mark-course-complete-" + course_id).length) {
    var data = jQuery("#ebox-mark-course-complete-" + course_id).attr(
      "data-name"
    );
...
jQuery(function () {
  ...
  jQuery("#course_progress_details").on(
    ...
    function () {
      var clicked_el = jQuery(this);
      var clicked_div = jQuery(clicked_el).parent(
        ".ebox-user-courses-access-edit"
      );
  ...
  jQuery("#course_progress_details").on(
    ...
    function () {
      ...
      if (typeof clicked_div !== "undefined") {
        ...
        if (
          jQuery("input.ebox-user-courses-access-changed", clicked_div).is(
            ":checked"
          )
        ) {
          var d = new Date();
    ...
    function (event) {
      ...
      if (_click_type == "course") {
        if (_click_checked == true) {
          ...
          var confirm_unchecked_title = course_checkbox.attr(
            "data-title-unchecked-children"
          );
          if (
            typeof confirm_unchecked_title !== "undefined" &&
            confirm_unchecked_title != ""
          ) {
      ...
      if (_click_type == "course" && _click_confirm == true) {
        ...
        var course_navigation_container =
          course_checkbox.siblings(".course_navigation");
        if (jQuery("input:checkbox", course_navigation_container).length) {
          jQuery("input:checkbox", course_navigation_container).each(function (
            ...
            if (
              jQuery(el).hasClass("ebox-mark-lesson-complete") ||
              jQuery(el).hasClass("ebox-mark-course-quiz-complete")
            ) {
    ...
    function (event) {
      ...
      if (_click_type == "lesson") {
        if (_click_checked == true) {
          ...
          var confirm_unchecked_title = lesson_checkbox.attr(
            "data-title-unchecked-children"
          );
          if (
            typeof confirm_unchecked_title !== "undefined" &&
      ...
      if (
        (_click_type == "lesson" || _click_type == "course") &&
        _click_confirm == true
      ) {
        var lesson_id = lesson_checkbox
          .prop("id")
          .replace("ebox-mark-lesson-complete-", "");
        if (typeof lesson_id !== "undefined" && lesson_id != "") {
          if (
            jQuery("input:checkbox", "#ebox_topic_dots-" + lesson_id)
              .length
          ) {
            jQuery("input:checkbox", "#ebox_topic_dots-" + lesson_id).each(
              function (el_idx, el) {
                // We only worry about children topics and quizzes
                if (
                  jQuery(el).hasClass("ebox-mark-topic-complete") ||
                  jQuery(el).hasClass("ebox-mark-lesson-quiz-complete")
                ) {
                  jQuery(el).trigger("click");
                }
              }
    ...
    function (event) {
      ...
      if (_click_type == "topic") {
        if (_click_checked == true) {
          ...
          var confirm_unchecked_title = topic_checkbox.attr(
            "data-title-unchecked-children"
          );
          if (
            typeof confirm_unchecked_title !== "undefined" &&
      ...
      if (
        (_click_type == "topic" || _click_type == "quiz") &&
        _click_checked != true
      ) {
      ...
      if (
        ...
        var topic_id = topic_checkbox
          .prop("id")
          .replace("ebox-mark-topic-complete-", "");

        if (
          jQuery("input:checkbox", "#ebox-quiz-list-" + topic_id).length
        ) {
          jQuery("input:checkbox", "#ebox-quiz-list-" + topic_id).each(
            function (el_idx, el) {
              if (jQuery(el).hasClass("ebox-mark-topic-quiz-complete")) {
                jQuery(el).trigger("click");
              }
            }
          );
  ...
  function update_parents(checkbox) {
    if (
      (_click_type == "quiz" || _click_type == "topic") &&
      (checkbox.hasClass("ebox-mark-topic-complete") ||
        checkbox.hasClass("ebox-mark-lesson-quiz-complete"))
    ) {
      var topic_list = checkbox.parents(".ebox_topic_widget_list");
      var lesson_id = jQuery(topic_list)
        .prop("id")
        .replace("ebox_topic_dots-", "");
      if (typeof lesson_id !== "undefined" && lesson_id != "") {
        if (jQuery("#ebox-mark-lesson-complete-" + lesson_id).length) {
          var checkboxes_total =
            jQuery("input.ebox-mark-topic-complete:checkbox", topic_list)
              .length +
            jQuery(
              "input.ebox-mark-lesson-quiz-complete:checkbox",
              topic_list
            ).length;
          var checkboxes_checked =
            jQuery(
              "input.ebox-mark-topic-complete:checkbox:checked",
              topic_list
            ).length +
            jQuery(
          ...
          //jQuery('#ebox-mark-lesson-complete-'+lesson_id).prop('checked', lesson_checked).triggerHandler('click');
          jQuery("#ebox-mark-lesson-complete-" + lesson_id).trigger(
            "click"
          );
        }
      }
      ...
      _click_type == "quiz" &&
      checkbox.hasClass("ebox-mark-topic-quiz-complete")
    ) {
      var quiz_list = checkbox.parents(".ebox-quiz-list");
      var topic_id = jQuery(quiz_list)
        .prop("id")
        .replace("ebox-quiz-list-", "");
      if (typeof topic_id !== "undefined" && topic_id != "") {
        if (jQuery("#ebox-mark-topic-complete-" + topic_id).length) {
          var checkboxes_total = jQuery(
            "input.ebox-mark-topic-quiz-complete:checkbox",
            quiz_list
          ).length;
          var checkboxes_checked = jQuery(
          ...
          //jQuery('#ebox-mark-topic-complete-'+topic_id).prop('checked', topic_checked).triggerHandler('click');
          jQuery("#ebox-mark-topic-complete-" + topic_id).trigger("click");
        }
      }
    } else if (
      checkbox.hasClass("ebox-mark-lesson-complete") ||
      checkbox.hasClass("ebox-mark-course-quiz-complete")
    ) {
      var lesson_list = checkbox.parents(".course_navigation");
      var course_id = jQuery(lesson_list)
        .prop("id")
        .replace("course_navigation-", "");
      if (typeof course_id !== "undefined" && course_id != "") {
        if (jQuery("#ebox-mark-course-complete-" + course_id).length) {
          var checkboxes_total =
            jQuery("input.ebox-mark-lesson-complete:checkbox", lesson_list)
              .length +
            jQuery(
              "input.ebox-mark-course-quiz-complete:checkbox",
              lesson_list
            ).length;
          var checkboxes_checked =
            jQuery(
              "input.ebox-mark-lesson-complete:checkbox:checked",
              lesson_list
            ).length +
            jQuery(
          ...
          //jQuery('#ebox-mark-course-complete-'+course_id).prop('checked', course_checked).triggerHandler('click');
          jQuery("#ebox-mark-course-complete-" + course_id).trigger(
            "click"
          );
        }
      }
...
function ebox_get_checkbox_data(element) {
  ...
  if (
    ...
    if (jQuery("form#posts-filter button.assignment_approve_single").length) {
      jQuery("form#posts-filter button.assignment_approve_single").on(
        ...
        function (e) {
          e.preventDefault();
          var assignment_id = jQuery(this)
            .attr("id")
            .replace("assignment_approve_", "");
          if (typeof assignment_id !== "undefined" && assignment_id != "") {
            if (
              jQuery("form#posts-filter input#cb-select-" + assignment_id)
                .length
            ) {
              jQuery("form#posts-filter input#cb-select-" + assignment_id).prop(
                "checked",
                true
              );
            }
            if (
              jQuery("form#posts-filter select#bulk-action-selector-top").length
            ) {
    ...
    if (jQuery("form#posts-filter input.ebox-award-points").length) {
      ...
      jQuery("form#posts-filter button.essay_approve_single").on(
        ...
        function (e) {
          ...
          if (typeof essay_id !== "undefined" && essay_id != "") {
            if (
              jQuery("form#posts-filter input#cb-select-" + essay_id).length
            ) {
              jQuery("form#posts-filter input#cb-select-" + essay_id).prop(
                "checked",
                true
              );
            }
  ...
  if (
    ...
    if (jQuery("form#posts-filter button.ld_remove_access_single").length) {
      jQuery("form#posts-filter button.ld_remove_access_single").on(
        ...
        function (e) {
          e.preventDefault();
          var transaction_id = jQuery(this)
            .attr("id")
            .replace("ld_remove_access_", "");

          if (typeof transaction_id !== "undefined" && transaction_id != "") {
            if (
              jQuery("form#posts-filter input#cb-select-" + transaction_id)
                .length
            ) {
              jQuery(
                "form#posts-filter input#cb-select-" + transaction_id
              ).prop("checked", true);
            }
            if (
              jQuery("form#posts-filter select#bulk-action-selector-top").length
...
jQuery(function () {
  jQuery(
    ...
    var form_nonce = jQuery("input#ld-team-list-view-nonce").val();
    ...
    var data_team_id = jQuery(e.target).attr("data-team-id");
    ...
    var post_data = {
      ...
      data: {
        ...
        nonce: data_nonce,
        slug: data_slug,
        team_id: data_team_id,
      },
    };
    ebox_data_team_reports_do_ajax(post_data, updateElement);
  });
});

function ebox_data_team_reports_do_ajax(post_data, updateElement) {
              ...
              if (jQuery(updateElement).length) {
                if (typeof reply_data.data.progress_percent !== "undefined") {
                  var progress_percent = parseInt(
                    reply_data.data.progress_percent
                  );
...
jQuery(function ($) {
  $("#email_team").on("click", function () {
    $("button#email_team").attr("disabled", true);
    $("span.sending_status").show();
    $("span.sending_result").html("").hide();

    var action = "ebox_team_emails";
    var team_ajaxurl = $("#team_email_ajaxurl").val();
    var nonce = $("#team_email_nonce").val();
    var team_id = $("#team_email_team_id").val();
    var team_subject = $("#team_email_sub").val();
    var team_message = "";

    if (is_tinyMCE_active()) {
      tinymce.triggerSave();
      team_message = tinymce.editors.teamemailtext.getContent();
    } else {
      team_message = $("#teamemailtext").val();
    }
    ...
    if (
      ...
      var post_data = {
        ...
        team_email_data: JSON.stringify({
          team_id: team_id,
          email_message: team_message,
          email_subject: team_subject,
        }),
      };
      ...
      jQuery.ajax({
        ...
        success: function (reply_data) {
          if (reply_data) {
            if (typeof reply_data !== "undefined") {
              if (
                typeof reply_data.data.message !== "undefined" &&
                reply_data.data.message != ""
              ) {
          ...
          $("button#email_team").attr("disabled", false);
        },
      });
    } else {
...
jQuery(function ($) {
  if (jQuery("form#post input#post_type").length) {
    ...
    // Ensure we only effect modules, Topics or Quizzes
    if (
      ...
      if (
        ...
        var primary_course_id = jQuery(
          "#ebox_course_navigation_admin_meta input#ld-course-primary"
        ).val();
        if (
          typeof primary_course_id !== "undefined" &&
          primary_course_id !== "" &&
          primary_course_id !== "0"
        ) {
            ...
            if (
              ...
              if (switcher_course_id !== primary_course_id) {
                ...
                if (
                  ...
                  ld_course_message = jQuery(
                    "#ebox_course_navigation_admin_meta span.ld-course-message"
                  ).html();
                }

                if (jQuery('select[name="' + post_type + '_course"]').length) {
                  jQuery('select[name="' + post_type + '_course"]').attr(
                    "disabled",
                    true
                  );
                  if (ld_course_message.length) {
                    jQuery("<p>" + ld_course_message + "</p>").insertBefore(
                      'select[name="' + post_type + '_course"]'
                    );
                  }
                }

                if (jQuery('select[name="' + post_type + '_lesson"]').length) {
                  jQuery('select[name="' + post_type + '_lesson"]').attr(
                    "disabled",
                    true
                  );
                  if (ld_course_message.length) {
                    jQuery("<p>" + ld_course_message + "</p>").insertBefore(
                      'select[name="' + post_type + '_lesson"]'
                    );
                  }
                }
              }
  ...
  if (
    jQuery("#ebox_admin_quiz_navigation select#ld-quiz-switcher").length
  ) {
  ...
  if (
    jQuery('#ebox_question_template input[name="templateLoad"]').length
  ) {
    jQuery('#ebox_question_template input[name="templateLoad"]').on(
      "click",
      function () {
        if (
          jQuery("#ebox_question_template select#templateLoadId").length
        ) {
          var template_load_url = jQuery(
  ...
  if (jQuery('#ebox_quiz_templates input[name="templateLoad"]').length) {
    jQuery('#ebox_quiz_templates input[name="templateLoad"]').on(
      "click",
      function () {
        if (jQuery("#ebox_quiz_templates select#templateLoadId").length) {
          var template_load_url = jQuery(
  ...
  if (
    ...
    jQuery("#quiz_progress_details").on("click", "a.remove-quiz", function (e) {
      ...
      if (jQuery("#ld-confirm-quiz-delete-message").length) {
        var quiz_delete_confirm_message = jQuery(
          "#ld-confirm-quiz-delete-message"
        ).html();
...
jQuery(function () {
  if (
      ...
      function (e) {
        ...
        if (!clicked_el.hasAttribute("disabled")) {
          ...
          if (typeof exam_data !== "undefined") {
            exam_data["action"] = "ebox_exam_process_reset";

            ebox_exam_process_ajax(clicked_el, exam_data);
          }
        }
      }
    );
    ...
    jQuery("#course_progress_details").on(
      ...
      function (e) {
        ...
        if (!clicked_el.hasAttribute("disabled")) {
          var exam_data = jQuery(clicked_el).data("exam");
          if (typeof exam_data !== "undefined") {
            exam_data["action"] = "ebox_exam_process_complete";
    ...
    function ebox_exam_process_ajax(clicked_el, exam_data) {
      jQuery.post(
        ajaxurl,
        exam_data,
        function (json) {
