jQuery( function( $ ) {
	if ( ( typeof ebox_admin_pointers_data.pointers !== 'undefined' ) && ( Object.keys( ebox_admin_pointers_data.pointers ).length > 0 ) ) {
		if ( ( typeof ebox_admin_pointers_data.pointer_color === 'undefined' ) || ( ebox_admin_pointers_data.pointers.pointer_color == '' ) ) {
			ebox_admin_pointers_data.pointer_color = '#00a0d2';
		}

		jQuery.each( ebox_admin_pointers_data.pointers, function( pointer_idx, pointer_item ) {
		...
		if ( jQuery( '.wp-pointer #ld-pointer-title-ebox-new-install' ).length ) {
			jQuery( '.wp-pointer #ld-pointer-title-ebox-new-install' ).each( function( idx, item ) {
				...
				if ( typeof pointer_el !== 'undefined' ) {
					...
					if ( typeof arrow_el !== 'undefined' ) {
						...
						*/
						//var pointer_color = ebox_admin_pointers_data.pointer_color;
						/*
						...
						if (typeof pointer_color === 'undefined') {
							pointer_color = ebox_admin_pointers_data.pointer_color;
