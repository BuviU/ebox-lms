...
function team_user_search() {
	SS1 = document.getElementById( 'ebox_team_users_search' );
	SS_View = document.getElementById( 'ebox_team_users_view' );
	search_for = document.getElementById( 'search_team' ).value.toLowerCase();
