...
require plugin_dir_path( __FILE__ ) . 'lib/class-ebox-gutenberg-block.php';
...
require plugin_dir_path( __FILE__ ) . 'blocks/ld-team-list/index.php';
require plugin_dir_path( __FILE__ ) . 'blocks/ld-user-teams/index.php';
require plugin_dir_path( __FILE__ ) . 'blocks/ld-team/index.php';
...
require plugin_dir_path( __FILE__ ) . 'blocks/ld-teaminfo/index.php';
