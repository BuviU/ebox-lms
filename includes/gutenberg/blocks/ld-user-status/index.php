 ...
 * as the ld_user_status shortcode used within ebox.
 *
 * @package ebox
 * @since 4.0.0
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_User_Status' ) ) ) {
	/**
	 * Class for handling ebox Infobar Block
	 */
	class ebox_Gutenberg_Block_User_Status extends ebox_Gutenberg_Block {

		/**
		 * Object constructor
		 */
		public function __construct() {
			$this->shortcode_slug   = 'ebox_user_status';
...
new ebox_Gutenberg_Block_User_Status();
