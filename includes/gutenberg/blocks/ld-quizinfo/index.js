...
const block_key = "ebox/ld-quizinfo";
const block_title = sprintf(
  // translators: placeholder: Quiz.
  _x("ebox %s Info [quizinfo]", "placeholder: Quiz", "ebox"),
        ...
        options={[
          {
            label: sprintf(
              // translators: placeholder: Quiz.
              _x("%s Title", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            ),
            value: "quiz_title",
          },
          {
            label: sprintf(
              // translators: placeholder: Quiz.
              _x("%s Score", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            ),
            value: "score",
          },
          {
            label: sprintf(
              // translators: placeholder: Quiz.
              _x("%s Count", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            ),
            value: "count",
          },
          {
            label: sprintf(
              // translators: placeholder: Quiz.
              _x("%s Pass", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            ),
            value: "pass",
          },
          {
            label: sprintf(
              // translators: placeholder: Quiz.
              _x("%s Timestamp", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            ),
            value: "timestamp",
          },
          {
            label: sprintf(
              // translators: placeholder: Quiz.
              _x("%s Points", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            ),
            value: "points",
          },
          {
            label: sprintf(
              // translators: placeholder: Quiz.
              _x("%s Total Points", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            ),
            value: "total_points",
          },
          {
            label: sprintf(
              // translators: placeholder: Quiz.
              _x("%s Percentage", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            ),
            value: "percentage",
          },
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Quiz.
              _x("%s Time Spent", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            ),
            value: "timespent",
          },
          {
            label: sprintf(
              // translators: placeholder: Quiz.
              _x("%s Form Field", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            ),
            value: "field",
          },
    ...
    const inspectorControls = (
      <InspectorControls key="controls">
        <PanelBody title={__("Settings", "ebox")}>
          ...
          />
          <TextControl
            label={__("Attempt timestamp", "ebox")}
            help={sprintf(
              // translators: placeholder: Quiz.
              _x(
