 ...
 * as the [course_inprogress] shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Course_In_Progress' ) ) ) {
	/**
	 * Class for handling ebox Course In Progress Block
	 */
	class ebox_Gutenberg_Block_Course_In_Progress extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Course_In_Progress();
