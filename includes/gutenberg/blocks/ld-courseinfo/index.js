...
const block_key = "ebox/ld-courseinfo";
const block_title = sprintf(
  // translators: placeholder: Course.
  _x("ebox %s Info [courseinfo]", "placeholder: Course", "ebox"),
        ...
        options={[
          {
            label: sprintf(
              // translators: placeholder: Course.
              _x("%s Title", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            ),
            value: "course_title",
          },
          {
            label: sprintf(
              // translators: placeholder: Course.
              _x("%s URL", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            ),
            value: "course_url",
          },
          {
            label: sprintf(
              // translators: placeholder: Course.
              _x("%s Points", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            ),
            value: "course_points",
          },
          {
            label: sprintf(
              // translators: placeholder: Course.
              _x("%s Price", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            ),
            value: "course_price",
          },
          {
            label: sprintf(
              // translators: placeholder: Course.
              _x("%s Price Type", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            ),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Course.
              _x("%s Enrolled Users Count", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            ),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Course.
              _x("Total User %s Points", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            ),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Course.
              _x("Total User %s Time", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            ),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Course.
              _x("%s Completed On (date)", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            ),
            value: "completed_on",
          },
          {
            label: sprintf(
              // translators: placeholder: Course.
              _x("%s Enrolled On (date)", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            ),
            value: "enrolled_on",
          },
          {
            label: sprintf(
              ...
              _x("Cumulative %s Score", "placeholder: Quizzes", "ebox"),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Quizzes.
              _x("Cumulative %s Points", "placeholder: Quizzes", "ebox"),
              ldlms_get_custom_label("quizzes")
            ),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Quizzes.
              _x("Cumulative %s Percentage", "placeholder: Quizzes", "ebox"),
              ldlms_get_custom_label("quizzes")
            ),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Quizzes.
              _x("Cumulative %s Time Spent", "placeholder: Quizzes", "ebox"),
              ldlms_get_custom_label("quizzes")
            ),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Quizzes.
              _x("Aggregate %s Percentage", "placeholder: Quizzes", "ebox"),
              ldlms_get_custom_label("quizzes")
            ),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Quizzes.
              _x("Aggregate %s Score", "placeholder: Quizzes", "ebox"),
              ldlms_get_custom_label("quizzes")
            ),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Quizzes.
              _x("Aggregate %s Points", "placeholder: Quizzes", "ebox"),
              ldlms_get_custom_label("quizzes")
            ),
          ...
          },
          {
            label: sprintf(
              // translators: placeholder: Quizzes.
              _x("Aggregate %s Time Spent", "placeholder: Quizzes", "ebox"),
              ldlms_get_custom_label("quizzes")
            ),
    ...
    if (show == "user_course_time") {
      field_seconds_format = (
        <SelectControl
          ...
          label={__("Seconds Format", "ebox")}
          options={[
            {
              label: __("Time - 20min 49sec", "ebox"),
              value: "time",
            },
            {
              label: __("Seconds - 1436", "ebox"),
              value: "seconds",
            },
          ]}
