...
const block_key = "ebox/ld-quiz-complete";
const block_title = sprintf(
  // translators: placeholder: Quiz.
  _x("ebox %s Complete", "placeholder: Quiz", "ebox"),
...
registerBlockType(block_key, {
  ...
  edit: (props) => {
    const {
      attributes: { course_id, quiz_id, user_id, autop },
      className,
      setAttributes,
    } = props;
    ...
    if (preview_quiz_id === 0) {
      if ("ebox-quiz" === ldlms_get_post_edit_meta("post_type")) {
