 ...
 * as the [student] shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Student' ) ) ) {
	/**
	 * Class for handling ebox ebox_Gutenberg_Block_Student Block
	 */
	class ebox_Gutenberg_Block_Student extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Student();
