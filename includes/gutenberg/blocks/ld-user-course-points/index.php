 ...
 * as the ld_user_course_points shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_User_Course_Points' ) ) ) {
	/**
	 * Class for handling ebox Profile Block
	 */
	class ebox_Gutenberg_Block_User_Course_Points extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_User_Course_Points();
