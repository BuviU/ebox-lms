 ...
 * as the [course_notstarted] shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Course_Not_Started' ) ) ) {
	/**
	 * Class for handling ebox Course Not Started Block
	 */
	class ebox_Gutenberg_Block_Course_Not_Started extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Course_Not_Started();
