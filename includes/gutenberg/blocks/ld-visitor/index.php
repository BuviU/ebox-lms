 ...
 * as the [visitor] shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Visitor' ) ) ) {
	/**
	 * Class for handling ebox Visitor Block
	 */
	class ebox_Gutenberg_Block_Visitor extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Visitor();
