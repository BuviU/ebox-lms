...
const block_key = "ebox/ld-topic-list";
const block_title = sprintf(
  // translators: placeholder: Topic.
  _x("ebox %s List", "placeholder: Topic", "ebox"),
  ldlms_get_custom_label("topic")
);
registerBlockType(block_key, {
  title: block_title,
  description: sprintf(
    // translators: placeholder: Topics.
    _x("This block shows a list of %s.", "placeholder: Topics", "ebox"),
    ldlms_get_custom_label("topics")
  ),
  icon: "list-view",
  ...
  edit: function (props) {
    ...
    const panelbody_header = (
      <PanelBody title={__("Settings", "ebox")}>
        ...
        <TextControl
          label={sprintf(
            // translators: placeholder: Topics.
            _x("%s per page", "placeholder: Topics", "ebox"),
            ldlms_get_custom_label("topics")
          )}
          help={sprintf(
    ...
    if (
      ldlms_settings["settings"]["topics_taxonomies"]["ld_topic_category"] ===
      "yes"
    ) {
      ...
      panel_topic_category_section = (
        <PanelBody
          title={sprintf(
            // translators: placeholder: Topic.
            _x("%s Category Settings", "placeholder: Topic", "ebox"),
            ldlms_get_custom_label("topic")
          )}
        ...
        >
          <TextControl
            label={sprintf(
              // translators: placeholder: Topic.
              _x("%s Category Slug", "placeholder: Topic", "ebox"),
              ldlms_get_custom_label("topic")
            )}
            help={sprintf(
              // translators: placeholder: Topics.
            ...
            onChange={(topic_category_name) =>
              setAttributes({ topic_category_name })
            }
          />
          <TextControl
            label={sprintf(
              // translators: placeholder: Topic.
              _x("%s Category ID", "placeholder: Topic", "ebox"),
              ldlms_get_custom_label("topic")
            )}
            help={sprintf(
              // translators: placeholder: Topics.
          ...
          <ToggleControl
            label={sprintf(
              // translators: placeholder: topic.
              _x("%s Category Selector", "placeholder: topic", "ebox"),
              ldlms_get_custom_label("topic")
            )}
            help={sprintf(
              // translators: placeholder: Topics.
            ...
            onChange={(topic_categoryselector) =>
              setAttributes({ topic_categoryselector })
            }
          />
        </PanelBody>
      );
    ...
    if (
      ldlms_settings["settings"]["topics_taxonomies"]["ld_topic_tag"] === "yes"
    ) {
      ...
      panel_topic_tag_section = (
        <PanelBody
          title={sprintf(
            // translators: placeholder: Topic.
            _x("%s Tag Settings", "placeholder: Topic", "ebox"),
            ldlms_get_custom_label("topic")
          )}
        ...
        >
          <TextControl
            label={sprintf(
              // translators: placeholder: Topic.
              _x("%s Tag Slug", "placeholder: Topic", "ebox"),
              ldlms_get_custom_label("topic")
            )}
            help={sprintf(
              // translators: placeholder: Topics.
          ...
          <TextControl
            label={sprintf(
              // translators: placeholder: Topic.
              _x("%s Tag ID", "placeholder: Topic", "ebox"),
              ldlms_get_custom_label("topic")
            )}
            help={sprintf(
              // translators: placeholder: Topics.
    ...
    if (
      ldlms_settings["settings"]["topics_taxonomies"]["wp_post_category"] ===
      "yes"
    ) {
    ...
    if (
      ldlms_settings["settings"]["topics_taxonomies"]["wp_post_tag"] === "yes"
    ) {
