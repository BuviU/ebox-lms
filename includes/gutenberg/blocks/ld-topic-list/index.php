 ...
 * as the ld_topic_list shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Topic_List' ) ) ) {
	/**
	 * Class for handling ebox Topic List Block
	 */
	class ebox_Gutenberg_Block_Topic_List extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Topic_List();
