...
const block_key = "ebox/ld-materials";
const block_title = __("ebox Materials", "ebox");
  ...
  edit: (props) => {
    ...
    const field_autop = (
      <ToggleControl
        ...
        help={__("Whether to format materials content using wpautop.", "ebox")}
        checked={!!autop}
