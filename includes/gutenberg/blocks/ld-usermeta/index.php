 ...
 * as the usermeta shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Usermeta' ) ) ) {
	/**
	 * Class for handling ebox Usermeta Block
	 */
	class ebox_Gutenberg_Block_Usermeta extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Usermeta();
