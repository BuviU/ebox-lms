...
const block_key = "ebox/ld-profile";
const block_title = __("ebox Profile", "ebox");
    ...
    const inspectorControls = (
      <InspectorControls key="controls">
        <PanelBody title={__("Settings", "ebox")}>
          ...
          />
          <ToggleControl
            label={__("Show Search", "ebox")}
            checked={!!show_search}
            onChange={(show_search) => setAttributes({ show_search })}
            help={__("LD30 template only", "ebox")}
          />
          <ToggleControl
            label={__("Show Profile Header", "ebox")}
            checked={!!show_header}
          ...
          <ToggleControl
            label={sprintf(
              ...
              _x("Show Earned %s Points", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            )}
          ...
          />
          <ToggleControl
            label={__("Show Profile Link", "ebox")}
          ...
          <ToggleControl
            label={sprintf(
              ...
              _x("Show User %s Attempts", "placeholder: Quiz", "ebox"),
              ldlms_get_custom_label("quiz")
            )}
          ...
          <ToggleControl
            label={sprintf(
              // translators: placeholder: Course.
              _x("Expand All %s Sections", "placeholder: Course", "ebox"),
              ldlms_get_custom_label("course")
            )}
            checked={!!expand_all}
