 ...
 * as the ld_profile shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Profile' ) ) ) {
	/**
	 * Class for handling ebox Profile Block
	 */
	class ebox_Gutenberg_Block_Profile extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Profile();
