 ...
 * as the ld_quiz_list shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Quiz_List' ) ) ) {
	/**
	 * Class for handling ebox Quiz List Block
	 */
	class ebox_Gutenberg_Block_Quiz_List extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Quiz_List();
