...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Course_List' ) ) ) {
	/**
	 * Class for handling ebox Course List Block
	 */
	class ebox_Gutenberg_Block_Course_List extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Course_List();
