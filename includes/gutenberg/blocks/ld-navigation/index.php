 ...
 * as the ld_navigation shortcode used within ebox.
 *
 * @package ebox
 * @since 4.0.0
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Navigation' ) ) ) {
	/**
	 * Class for handling ebox Navigation Block
	 */
	class ebox_Gutenberg_Block_Navigation extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Navigation();
