 ...
 * as the ld_reset_password shortcode used within ebox.
 *
 * @package ebox
 * @since 4.4.0
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Reset_Password' ) ) ) {
	/**
	 * Class for handling ebox Reset Password Block
	 */
	class ebox_Gutenberg_Block_Reset_Password extends ebox_Gutenberg_Block {
		/**
		 * Object constructor
		 */
...
new ebox_Gutenberg_Block_Reset_Password();
