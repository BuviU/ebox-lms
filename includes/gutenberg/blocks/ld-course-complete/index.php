...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Course_Complete' ) ) ) {
	/**
	 * Class for handling ebox Course Complete Block
	 */
	class ebox_Gutenberg_Block_Course_Complete extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Course_Complete();
