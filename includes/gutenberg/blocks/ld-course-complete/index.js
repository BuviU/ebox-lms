...
const block_title = sprintf(
  ...
  _x("ebox %s Complete", "placeholder: Course", "ebox"),
  ldlms_get_custom_label("course")
);
const block_key = "ebox/ld-course-complete";
...
registerBlockType(block_key, {
  ...
  edit: (props) => {
    ...
    if (p_course_id === 0) {
      p_course_id = ldlms_get_integer_value(
        ldlms_get_post_edit_meta("course_id")
      );
    }
