 ...
 * as the ld_course_info shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Course_Info' ) ) ) {
	/**
	 * Class for handling ebox Course Info Block
	 */
	class ebox_Gutenberg_Block_Course_Info extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Course_Info();
