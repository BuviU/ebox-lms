 ...
 * as the ld_course_expire_status shortcode used within ebox.
 *
 * @package ebox
 * @since 2.5.9
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Course_Expire_Status' ) ) ) {
	/**
	 * Class for handling ebox Course Expire Status Block
	 */
	class ebox_Gutenberg_Block_Course_Expire_Status extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Course_Expire_Status();
