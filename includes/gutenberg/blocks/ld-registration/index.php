 ...
 * as the ld_registration shortcode used within ebox.
 *
 * @package ebox
 * @since 3.6.0
 */
...
if ( ( class_exists( 'ebox_Gutenberg_Block' ) ) && ( ! class_exists( 'ebox_Gutenberg_Block_Registration' ) ) ) {
	/**
	 * Class for handling ebox Profile Block
	 */
	class ebox_Gutenberg_Block_Registration extends ebox_Gutenberg_Block {
...
new ebox_Gutenberg_Block_Registration();
