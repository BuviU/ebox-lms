...
const block_key = "ebox/ld-registration";
const block_title = __("ebox Registration", "ebox");

registerBlockType(block_key, {
  title: block_title,
  description: __("Shows the registration form", "ebox"),
  icon: "id-alt",
      ...
      <InspectorControls key="controls">
        <PanelBody title={__("Styling", "ebox")} initialOpen={true}>
          <TextControl
            ...
            help={__("Sets the width of the registration form.", "ebox")}
            value={width || ""}
            type={"string"}
