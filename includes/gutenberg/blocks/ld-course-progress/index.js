...
const block_key = "ebox/ld-course-progress";
const block_title = sprintf(
  // translators: placeholder: Course.
  _x("ebox %s Progress", "placeholders: Course", "ebox"),
...
registerBlockType(block_key, {
  ...
  edit: (props) => {
    ...
    const {
      attributes: { user_id, preview_show, preview_user_id, example_show },
      setAttributes,
    } = props;
