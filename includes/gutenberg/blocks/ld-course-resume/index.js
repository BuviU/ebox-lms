...
const block_key = "ebox/ld-course-resume";
const block_title = sprintf(
  // translators: placeholder: Course.
  _x("%s Resume", "placeholder: Course", "ebox"),
...
registerBlockType(block_key, {
  ...
  description: sprintf(
    // translators: placeholder: Course.
    _x("Return to %s link/button.", "placeholder: Course", "ebox"),
    ldlms_get_custom_label("course")
  ),
