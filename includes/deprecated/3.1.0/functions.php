...
if ( ! function_exists( 'ebox_get_valid_transient' ) ) {
	/**
	 ...
	 * @return mixed
	 */
	function ebox_get_valid_transient( $transient_key = '' ) {
...
if ( ! function_exists( 'ebox_set_transient' ) ) {
	 ...
	 * @return boolean
	 */
	function ebox_set_transient( $transient_key = '', $transient_data = '', $transient_expire = MINUTE_IN_SECONDS ) {
		if ( function_exists( '_deprecated_function' ) ) {
