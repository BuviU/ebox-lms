...
if ( ! function_exists( 'leandash_redirect_post_location' ) ) {
	 ...
	 *
	 * @since 2.5.0
	 * @deprecated 2.5.0 Use {@see 'ebox_redirect_post_location'} instead.
	 *
	 * @param string $location Optional. Location.  Default empty.
	 */
	function leandash_redirect_post_location( $location = '' ) {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '2.5.0', 'ebox_redirect_post_location()' );
		}

		return ebox_redirect_post_location( $location );
	}
}
