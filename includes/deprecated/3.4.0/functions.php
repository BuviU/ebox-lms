 ...
 * $ebox_lms->course_display_settings();
 * $ebox_lms->lesson_display_settings();
 * $ebox_lms->topic_display_settings();
 * $ebox_lms->quiz_display_settings();
 */
...
if ( ! function_exists( 'is_quiz_accessable' ) ) {
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 3.4.0 Use {@see 'ebox_is_quiz_accessable'} instead.
	 *
	...
	function is_quiz_accessable( $user_id = null, $post = null, $return_incomplete = false, $course_id = 0 ) { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_is_quiz_accessable' );
		}
		return ebox_is_quiz_accessable( $user_id, $post, $return_incomplete, $course_id );
	}
}
...
if ( ! function_exists( 'has_global_quizzes' ) ) {
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 3.4.0 Use {@see 'ebox_has_global_quizzes'} instead.
	 *
	...
	function has_global_quizzes( $id = null ) { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_has_global_quizzes' );
		}

		return ebox_has_global_quizzes( $id );
	}
}
...
if ( ! function_exists( 'is_all_global_quizzes_complete' ) ) {
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 3.4.0 Use {@see 'ebox_is_all_global_quizzes_complete'} instead.
	 *
	...
	function is_all_global_quizzes_complete( $user_id = null, $id = null ) { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_is_all_global_quizzes_complete' );
		}

		return ebox_is_all_global_quizzes_complete( $user_id, $id );
	}
}

if ( ! function_exists( 'ebox_get_course_steps_ORG' ) ) {
	/**
	 * Gets the list of course step IDs.
	 *
	 * @deprecated 3.4.0 Use {@see 'ebox_get_course_steps'} instead.
	 *
	 ...
	 */
	function ebox_get_course_steps_ORG( $course_id = 0, $include_post_types = array( 'ebox-modules', 'ebox-topic' ) ) { // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_get_course_steps' );
		}

		return ebox_get_course_steps( $course_id, $include_post_types );
	}
}

if ( ! function_exists( 'ebox_quiz_continue_link_OLD' ) ) {
	/**
	 * Outputs the quiz continue link(old).
	 *
	 * @deprecated 3.4.0 Use {@see 'ebox_quiz_continue_link'} instead.
	 *
	 * @param int $id Quiz ID.
	 *
	 * @return string The quiz continue link output.
	 */
	function ebox_quiz_continue_link_OLD( $id ) { // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid

		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_quiz_continue_link' );
		}

		return ebox_quiz_continue_link( $id );
	}
}

if ( ! function_exists( 'ebox_get_global_quiz_list_OLD' ) ) {
	/**
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 3.4.0 Use {@see 'ebox_get_global_quiz_list'} instead.
	 *
	 * @param int|null $id An ID of the resource.
	 *
	 * @return array An array of quizzes.
	 */
	function ebox_get_global_quiz_list_OLD( $id = null ) { // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid

		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_get_global_quiz_list' );
		}

		return ebox_get_global_quiz_list( $id );
	}
}

if ( ! function_exists( 'ebox_course_get_steps_by_type_ORG1' ) ) {
	/**
	 * Gets the course steps by type.
	 *
	 * @deprecated 3.4.0 Use {@see 'ebox_course_get_steps_by_type'} instead.
	 *
	 * @param int    $course_id Optional. Course ID. Default 0.
	 ...
	 * @return array An array of course step IDs.
	 */
	function ebox_course_get_steps_by_type_ORG1( $course_id = 0, $step_type = '' ) { // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid

		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_course_get_steps_by_type' );
		}

		return ebox_course_get_steps_by_type( $course_id, $step_type );
	}
}

if ( ! function_exists( 'ebox_get_legacy_course_id' ) ) {
	/**
	 ...
	 */
	function ebox_get_legacy_course_id( $id = null ) {
...
if ( ! function_exists( 'should_enqueue_assets' ) ) {
	...
	function should_enqueue_assets() { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
		...
		if ( ( 'post' === $screen->base && 'ebox-courses' === get_post_type( $course_id ) ) ||
...
if ( ! function_exists( 'ebox_filter_lesson_options' ) ) {
	/**
	 ...
	 */
	function ebox_filter_lesson_options( $options, $location, $values ) {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0' );
		}
...
if ( ! function_exists( 'ebox_transition_course_shared_steps' ) ) {
	/**
	 ...
	 */
	function ebox_transition_course_shared_steps( $course_id = 0 ) {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0' );
		}
...
if ( ! function_exists( 'is_previous_complete' ) ) {
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 3.4.0 Use {@see 'ebox_is_previous_complete'} instead.
	 *
	...
	function is_previous_complete( $post ) { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_is_previous_complete' );
		}

		return ebox_is_previous_complete( $post );
	}
}

if ( ! function_exists( 'ebox_course_set_modules_start_page' ) ) {
	/**
	 * Redirects users to the next available lesson page when course lesson pagination is enabled.
	 *
	 * For example, we have a course with 100 modules and the course has per page set to 10. The student can complete
	 * up to lesson 73. When the student returns to the course we don't want to default to show the first page
	 * (modules 1-10). Instead, we want to redirect the user to page 7 showing modules 71-80.
	 *
	 * @since 2.5.4
	 * @deprecated 3.4.0
	 */
	function ebox_course_set_modules_start_page() {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0' );
		}
	}
...
if ( ! function_exists( 'wp_ajax_ld_course_registered_pager' ) ) {
	 ...
	 *
	 * @deprecated 3.4.0 Use {@see 'ebox_ajax_course_registered_pager'} instead.
	 *
	 * @return void|string
	 */
	function wp_ajax_ld_course_registered_pager() {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_ajax_course_registered_pager' );
		}

		return ebox_ajax_course_registered_pager();
	}
}
...
if ( ! function_exists( 'wp_ajax_ld_course_progress_pager' ) ) {
	 ...
	 *
	 * @deprecated 3.4.0 Use {@see 'ebox_ajax_course_progress_pager'} instead.
	 *
	 * @return void|string
	 */
	function wp_ajax_ld_course_progress_pager() {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_ajax_course_progress_pager' );
		}

		return ebox_ajax_course_progress_pager();
	}
}
...
if ( ! function_exists( 'wp_ajax_ld_quiz_progress_pager' ) ) {
	 ...
	 * Fires on `ld_course_progress_pager` AJAX action.
	 *
	 * @deprecated 3.4.0 Use {@see 'ebox_ajax_quiz_progress_pager'} instead.
	 *
	 * @return void|string
	 */
	function wp_ajax_ld_quiz_progress_pager() {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_ajax_quiz_progress_pager' );
		}

		return ebox_ajax_quiz_progress_pager();
	}
}
...
if ( ! function_exists( 'wp_ajax_ld_course_navigation_pager' ) ) {
	 ...
	 *
	 * @since 2.5.4
	 * @deprecated 3.4.0 Use {@see 'ebox_ajax_course_navigation_pager'} instead.
	 */
	function wp_ajax_ld_course_navigation_pager() {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_ajax_course_navigation_pager' );
		}

		return ebox_ajax_course_navigation_pager();
	}
}
...
if ( ! function_exists( 'wp_ajax_ld_course_navigation_admin_pager' ) ) {
	 ...
	 *
	 * @since 2.5.4
	 * @deprecated 3.4.0 Use {@see 'ebox_ajax_course_navigation_admin_pager'} instead.
	 */
	function wp_ajax_ld_course_navigation_admin_pager() {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_ajax_course_navigation_admin_pager' );
		}

		return ebox_ajax_course_navigation_admin_pager();
	}
}
...
if ( ! function_exists( 'lesson_hasassignments' ) ) { // cspell:disable-line.
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 3.4.0 Use {@see 'ebox_lesson_hasassignments'} instead. // cspell:disable-line.
	 *
	...
	function lesson_hasassignments( $post ) { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound // cspell:disable-line.
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_lesson_hasassignments' ); // cspell:disable-line.
		}

		return ebox_lesson_hasassignments( $post ); // cspell:disable-line.
	}
}

if ( ! function_exists( 'get_course_teams_users_access' ) ) {
	/**
	 * Gets the team's user IDs if the course is associated with the team.
	 *
	 * @since 2.3.0
	 * @deprecated 3.4.0 Use {@see 'ebox_get_course_teams_users_access'} instead.
	 *
	 * @param int $course_id Optional. Course ID. Default 0.
	 *
	 * @return array An array of user IDs.
	 */
	function get_course_teams_users_access( $course_id = 0 ) {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_get_course_teams_users_access' );
		}

		return ebox_get_course_teams_users_access( $course_id );
	}
}
...
if ( ! function_exists( 'array_map_r' ) ) {
	 ...
	 *
	 * @since 2.1.2
	 * @deprecated 3.4.0 Use {@see 'ebox_array_map_r'} instead.
	 *
	...
	function array_map_r( $func, $arr ) {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_array_map_r' );
		}

		return ebox_array_map_r( $func, $arr );
	}
}

if ( ! function_exists( 'ebox_convert_settings_to_single' ) ) {
	/**
	 ...
	 */
	function ebox_convert_settings_to_single( $post_id = 0, $settings = array(), $prefix = '' ) {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0' );
		}
	}
...
if ( ! function_exists( 'ebox_check_convert_settings_to_single' ) ) {
	/**
	 ...
	 */
	function ebox_check_convert_settings_to_single( $post_id = 0, $prefix = '' ) {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0' );
		}
	}
...
if ( ! function_exists( 'ebox_get_report_user_ids_NEW_PP21' ) ) {
	/**
	 ...
	 * show all users.
	 *
	 * @deprecated 3.4.0 Use {@see 'ebox_get_report_user_ids'} instead.
	 *
	 ...
	 * @return array An array of user IDs.
	 */
	function ebox_get_report_user_ids_NEW_PP21( $user_id = 0, $query_args = array() ) {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_get_report_user_ids' );
		}

		return ebox_get_report_user_ids( $user_id, $query_args );
	}
}

if ( ! function_exists( 'ld_remove_modules_and_quizzes_page' ) ) {
	/**
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 3.4.0 Use {@see 'ebox_remove_modules_and_quizzes_page'} instead.
	 *
	 * @param WP $wp The `WP` object.
	 */
	function ld_remove_modules_and_quizzes_page( $wp ) { //phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_remove_modules_and_quizzes_page' );
		}

		return ebox_remove_modules_and_quizzes_page( $wp );
	}
}
...
if ( ! function_exists( 'ld_footer_payment_buttons' ) ) {
	 ...
	 *
	 * @deprecated 3.4.0 Use {@see 'ebox_footer_payment_buttons'} instead.
	 *
	...
	function ld_footer_payment_buttons() { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_footer_payment_buttons' );
		}

		return ebox_footer_payment_buttons();
	}
}
...
if ( ! function_exists( 'wpLD_tiny_mce_before_init' ) ) {
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 3.4.0 Use {@see 'ebox_wp_tiny_mce_before_init'} instead.
	 *
	...
	function wpLD_tiny_mce_before_init( $init_array ) { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound, WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_wp_tiny_mce_before_init' );
		}

		return ebox_wp_tiny_mce_before_init( $init_array );
	}
}

if ( ! function_exists( 'filter_mce_css' ) ) {
	/**
	 * Loads editor styles for ebox.
	 *
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 3.4.0 Use {@see 'ebox_filter_mce_css'} instead.
	 *
	...
	function filter_mce_css( $mce_css = '' ) { //phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_filter_mce_css' );
		}

		return ebox_filter_mce_css( $mce_css );
	}
}
...
if ( ! function_exists( 'is_ebox_license_valid' ) ) {
	/**
	 * Checks Whether the ebox license is valid or not.
	 *
	 * @since 2.1.0
	 * @deprecated 3.4.0 Use {@see 'ebox_is_ebox_license_valid'} instead.
	 *
	 * @return boolean
	 */
	function is_ebox_license_valid() {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.4.0', 'ebox_is_ebox_license_valid' );
		}

		return ebox_is_ebox_license_valid();
	}
}
