...
if ( ! function_exists( 'is_data_upgrade_quiz_questions_updated' ) ) {
	 ...
	 *
	 * @deprecated 3.3.0 Use {@see 'ebox_is_data_upgrade_quiz_questions_updated'} instead.
	 */
	function is_data_upgrade_quiz_questions_updated() {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.3.0', 'ebox_is_data_upgrade_quiz_questions_updated' );
		}

		return ebox_is_data_upgrade_quiz_questions_updated();
	}
}
...
if ( ! function_exists( 'leandash_get_question_pro_fields' ) ) {
	 ...
	 *
	 * @deprecated 3.3.0 Use {@see 'ebox_get_question_pro_fields'} instead.
	 *
	...
	function leandash_get_question_pro_fields( $question_pro_id = 0, $fields = null ) {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.3.0', 'ebox_get_question_pro_fields' );
		}

		return ebox_get_question_pro_fields( $question_pro_id, $fields );
	}
}
...
if ( ! function_exists( 'leandash_get_quiz_pro_fields' ) ) {
	...
	function leandash_get_quiz_pro_fields( $quiz_pro_id = 0, $fields = null ) {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.3.0', 'ebox_get_quiz_pro_fields' );
		}

		return ebox_get_quiz_pro_fields( $quiz_pro_id, $fields );
	}
}
...
if ( ! function_exists( 'leardash_min_asset' ) ) {
	 ...
	 *
	 * @deprecated 3.3.0 Use {@see 'ebox_min_asset'} instead.
	 */
	function leardash_min_asset() {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.3.0', 'ebox_min_asset' );
		}

		return ebox_min_asset();
	}
}
...
if ( ! function_exists( 'leardash_min_builder_asset' ) ) {
	 ...
	 *
	 * @deprecated 3.3.0 Use {@see 'ebox_min_builder_asset'} instead.
	 */
	function leardash_min_builder_asset() {
		if ( function_exists( '_deprecated_function' ) ) {
			_deprecated_function( __FUNCTION__, '3.3.0', 'ebox_min_builder_asset' );
		}

		return ebox_min_builder_asset();
	}
}
