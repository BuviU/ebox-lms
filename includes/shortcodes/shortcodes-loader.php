...
require_once __DIR__ . '/ld_team_user_list.php';
require_once __DIR__ . '/ld_user_teams.php';
...
require_once __DIR__ . '/ld_team.php';
...
require_once __DIR__ . '/ld_team_list.php';
require_once __DIR__ . '/ld_teaminfo.php';
require_once __DIR__ . '/ld_registration.php';
require_once __DIR__ . '/ld_infobar.php';
require_once __DIR__ . '/ld_materials.php';
require_once __DIR__ . '/ebox_user_status.php';
