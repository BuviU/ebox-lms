...
if ( ! defined( 'ebox_REST_API_NAMESPACE' ) ) {
	/**
	 * Define ebox LMS - Set REST API Namespace.
	 *
	 * @since 2.4.5
	 *
	 * @var string Default is 'ldlms'.
	 */
	define( 'ebox_REST_API_NAMESPACE', 'ldlms' );
}
if ( ! defined( 'ebox_REST_API_DIR' ) ) {
	/**
	 * Define ebox LMS - Set the REST API library path.
	 *
	 ...
	 */
	define( 'ebox_REST_API_DIR', dirname( __FILE__ ) );
}

require_once ebox_LMS_PLUGIN_DIR . 'includes/gutenberg/lib/class-ld-rest-gutenberg-posts-controller.php';

if ( ! class_exists( 'ebox_REST_API' ) ) {
	...
	class ebox_REST_API {
		...
		/**
		 * Init function to all the ebox REST API namespace and endpoints.
		 *
		 * @since 2.4.5
		 */
			...
			if ( ( self::enabled() ) && ( self::check_registered_post_type() ) ) {
				...
				$controllers_v1 = array(
					'LD_REST_Echo_Controller_V1'          => array(
						...
						'file'            => ebox_REST_API_DIR . '/v1/class-ld-rest-echo-controller.php',
					),
					'LD_REST_Courses_Controller_V1'       => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v1/class-ld-rest-courses-controller.php',
					),
					'LD_REST_modules_Controller_V1'       => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v1/class-ld-rest-modules-controller.php',
					),
					'LD_REST_Topics_Controller_V1'        => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v1/class-ld-rest-topics-controller.php',
					),
					'LD_REST_Quizzes_Controller_V1'       => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v1/class-ld-rest-quizzes-controller.php',
					),
					'LD_REST_Teams_Controller_V1'        => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v1/class-ld-rest-teams-controller.php',
					),
					'LD_REST_Users_Teams_Controller_V1'  => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v1/class-ld-rest-users-teams-controller.php',
					),
					'LD_REST_Users_Courses_Controller_V1' => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v1/class-ld-rest-users-courses-controller.php',
					),
					'LD_REST_Questions_Controller_V1'     => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v1/class-ld-rest-questions-controller.php',
					),
					'LD_REST_Sections_Controller_V1'      => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v1/class-ld-rest-sections-controller.php',
					),
				);
				...
				$controllers_v2 = array(
					'LD_REST_Courses_Controller_V2'        => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-courses-controller.php',
					),
					'LD_REST_modules_Controller_V2'        => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-modules-controller.php',
					),
					'LD_REST_Topics_Controller_V2'         => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-topics-controller.php',
					),
					'LD_REST_Quizzes_Controller_V2'        => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-quizzes-controller.php',
					),
					'LD_REST_Essays_Controller_V2'         => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-essays-controller.php',
					),
					'LD_REST_Questions_Controller_V2'      => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-questions-controller.php',
					),
					'LD_REST_Assignments_Controller_V2'    => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-assignments-controller.php',
					),
					'LD_REST_Teams_Controller_V2'         => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-teams-controller.php',
					),
					'LD_REST_Users_Courses_Controller_V2'  => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-users-courses-controller.php',
					),
					'LD_REST_Users_Teams_Controller_V2'   => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-users-teams-controller.php',
					),
					'LD_REST_Users_Course_Progress_Controller_V2' => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-users-course-progress-controller.php',
					),
					'LD_REST_Users_Quiz_Progress_Controller_V2' => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-users-quiz-progress-controller.php',
					),
					'LD_REST_Quiz_Statistics_Controller_V2' => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-quiz-statistics-controller.php',
					),
					'LD_REST_Quiz_Form_Entries_Controller_V2' => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-quiz-form-entries-controller.php',
					),
					'LD_REST_Echo_Controller_V2'           => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-echo-controller.php',
					),
					'LD_REST_Price_Types_Controller_V2'    => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-price-types-controller.php',
					),
					'LD_REST_Question_Types_Controller_V2' => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-question-types-controller.php',
					),
					'LD_REST_Progress_Status_Controller_V2' => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-progress-status-controller.php',
					),

					'LD_REST_Exams_Controller_V2'          => array(
						'register_routes' => true,
						'file'            => ebox_REST_API_DIR . '/v2/class-ld-rest-exams-controller.php',
					),
				);
				...
				$this->controllers = apply_filters( 'ebox-rest-api-controllers', $this->controllers );
		...
		public static function enabled( $post_type = '' ) {
			...
			if ( ( defined( 'ebox_REST_API_ENABLED' ) ) && ( true === ebox_REST_API_ENABLED ) ) {
				if ( ebox_Settings_Section::get_section_setting( 'ebox_Settings_Section_General_REST_API', 'enabled' ) === 'yes' ) {
					$return = true;
				}
			}

			/**
			 * Filters whether the ebox REST API is enabled or not.
			 *
			 ...
			 */
			return apply_filters( 'ebox_rest_api_enabled', $return, $post_type );
		}
		...
		public static function gutenberg_enabled( $post_type = '' ) {
			 ...
			 * @param string  $post_type The slug of the post type to be checked.
			 */
			return apply_filters( 'ebox_gutenberg_enabled', $return, $post_type );
		}
			...
			if ( ! empty( $post_type ) ) {
				switch ( $post_type ) {
					...
					case ebox_get_post_type_slug( 'lesson' ):
						if ( self::enabled( $post_type ) ) {
							$rest_controller = 'LD_REST_modules_Controller_V1';
						} elseif ( self::gutenberg_enabled( $post_type ) ) {
							$rest_controller = 'LD_REST_Posts_Gutenberg_Controller';
						}
						break;
					...
					case ebox_get_post_type_slug( 'team' ):
						if ( self::enabled( $post_type ) ) {
							$rest_controller = 'LD_REST_Teams_Controller_V1';
						} elseif ( self::gutenberg_enabled( $post_type ) ) {
							$rest_controller = 'LD_REST_Posts_Gutenberg_Controller';
						}
						break;
		...
		/**
		 * Check that the ebox custom post types are registered.
		 *
		...
		public static function check_registered_post_type() : bool {
			...
			if ( ( is_array( $post_types ) ) && ( isset( $post_types[ ebox_get_post_type_slug( 'course' ) ] ) ) ) {
				return true;
			}
