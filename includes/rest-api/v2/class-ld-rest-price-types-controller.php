<?php
/**
 * ebox REST API V2 Price Types Controller.
 *
 * @since 3.3.0
...
if ( ( ! class_exists( 'LD_REST_Price_Types_Controller_V2' ) ) && ( class_exists( 'WP_REST_Controller' ) ) ) {
	...
	/**
	 * Class ebox REST API V2 Price Types Controller.
	 *
	 * @since 3.3.0
	...
	class LD_REST_Price_Types_Controller_V2 extends WP_REST_Controller /* phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound */ {
		...
		public function register_routes() {
			...
			register_rest_route(
				...
				array(
					'args'   => array(
						'slug' => array(
							'description' => __( 'An alphanumeric identifier for the price type.', 'ebox' ),
							'type'        => 'string',
						),
					),
					array(
		...
		protected function init_types_set() {
			$this->types = array(
				...
				'subscribe' => array(
					'slug'        => 'subscribe',
					'name'        => esc_html__( 'Recurring', 'ebox' ),
					'description' => sprintf(
						// translators: placeholder: course, course.
		...
		public function get_item_schema() {
			...
			$schema = array(
				...
				'properties' => array(
					'name'        => array(
						'description' => __( 'The title for the price type.', 'ebox' ),
						'type'        => 'string',
						'context'     => array( 'embed', 'view' ),
						'readonly'    => true,
					),
					'description' => array(
						'description' => __( 'The description for the price type.', 'ebox' ),
						'type'        => 'string',
						'context'     => array( 'embed', 'view' ),
						'readonly'    => true,
					),
