<?php
/**
 * ebox REST API V2 Quiz Form Entries Controller.
 *
 * @since 3.5.0
...
if ( ( ! class_exists( 'LD_REST_Quiz_Form_Entries_Controller_V2' ) ) && ( class_exists( 'WP_REST_Controller' ) ) ) {
	...
	/**
	 * Class ebox REST API V2 Quiz Form Entries Controller.
	 *
	 * @since 3.5.0
		...
		public function get_item_schema() {
			...
			$schema = array(
				...
				'properties' => array(
					...
					'date'      => array(
						'description' => esc_html__( 'Date of entry', 'ebox' ),
						'type'        => array(
							'string',
							'null',
						),
					...
					'form_data' => array(
						'description' => esc_html__( 'Form entry details', 'ebox' ),
						'type'        => array(
							'array',
							'null',
						),
