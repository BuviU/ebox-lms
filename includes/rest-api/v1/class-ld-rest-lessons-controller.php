<?php
/**
 * Class REST API V1 modules Post Controller.
 *
 * @since 2.5.8
...
if ( ( ! class_exists( 'LD_REST_modules_Controller_V1' ) ) && ( class_exists( 'LD_REST_Posts_Controller_V1' ) ) ) {

	/**
	 * Class Class REST API V1 modules Post Controller.
	 *
	 * @since 2.5.8
	 */
	class LD_REST_modules_Controller_V1 extends LD_REST_Posts_Controller_V1 /* phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound */ {
		...
		/**
		 * Check modules Read Permissions.
		 *
		 * @since 2.5.8
		 *
		 * @param object $request WP_REST_Request instance.
