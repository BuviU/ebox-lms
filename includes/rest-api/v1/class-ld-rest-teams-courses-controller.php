<?php
/**
 * ebox REST API V1 Teams Courses Post Controller.
 *
 * @since 2.5.8
...
if ( ( ! class_exists( 'LD_REST_Teams_Courses_Controller_V1' ) ) && ( class_exists( 'LD_REST_Posts_Controller_V1' ) ) ) {

	/**
	 * Class ebox REST API V1 Teams Courses Post Controller.
	 *
	 * @since 2.5.8
	 */
	class LD_REST_Teams_Courses_Controller_V1 extends LD_REST_Posts_Controller_V1 /* phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound */ {
			...
			register_rest_route(
				...
				array(
					'args'   => array(
						'id' => array(
							// translators: team.
							'description' => sprintf( esc_html_x( '%s ID to enroll into.', 'placeholder: team', 'ebox' ), ebox_get_custom_label( 'team' ) ),
							'required'    => true,
							'type'        => 'integer',
						),
					),
					...
					array(
						...
						'args'                => array(
							'course_ids' => array(
								// translators: course, team.
								'description' => sprintf( esc_html_x( '%1$s IDs to enroll into %2$s.', 'placeholder: course, team', 'ebox' ), ebox_get_custom_label( 'course' ), ebox_get_custom_label_lower( 'team' ) ),
								'required'    => true,
								'type'        => 'array',
								'items'       => array(
									'type' => 'integer',
					...
					array(
						...
						'args'                => array(
							'course_ids' => array(
								// translators: course, team.
								'description' => sprintf( esc_html_x( '%1$s IDs to remove from %2$s.', 'placeholder: course, team', 'ebox' ), ebox_get_custom_label( 'course' ), ebox_get_custom_label_lower( 'team' ) ),
								'required'    => true,
								'type'        => 'array',
								'items'       => array(
									'type' => 'integer',
		...
		public function get_schema() {
			...
			$schema = array(
				...
				'properties' => array(
					...
					'course_ids' => array(
						// translators: course.
						'description' => sprintf( esc_html_x( 'The %s IDs', 'placeholder: course', 'ebox' ), ebox_get_custom_label_lower( 'course' ) ),
						'type'        => 'array',
						'items'       => array(
							'type' => 'integer',
						),
		...
		/**
		 * Check Teams Courses Read Permissions.
		 *
		 * @since 2.5.8
		 *
		...
		/**
		 * Check Teams Courses Update Permissions.
		 *
		 * @since 2.5.8
		 *
		 * @param object $request WP_REST_Request instance.
		...
		/**
		 * Check Teams Courses Delete Permissions.
		 *
		 * @since 2.5.8
		 *
		 * @param object $request WP_REST_Request instance.
		...
		public function get_teams_courses( $request ) {
			...
			/**
			 * Filters the query arguments for teams courses REST request.
			 *
			 ...
			 *
			 * @param array           $args    An array of query arguments for getting teams courses.
			 * @param WP_REST_Request $request The REST request object.
			 */
			$args       = apply_filters( 'ebox_rest_teams_courses_query', $args, $request );
