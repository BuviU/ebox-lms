<?php
/**
 * ebox REST API V1 Users Quiz Attempts Controller.
 *
 * @since 2.5.8
...
if ( ( ! class_exists( 'LD_REST_Users_Quiz_Attempts_Controller_V1' ) ) && ( class_exists( 'LD_REST_Posts_Controller_V1' ) ) ) {
	...
	/**
	 * Class ebox REST API V1 Users Quiz Attempts Controller.
	 *
	 * @since 2.5.8
	 */
		...
		public function get_quiz_attempts_permissions_check( $request ) {
			...
			if ( empty( $current_user_id ) ) {
				if ( ! current_user_can( 'edit_user', $user_id ) ) {
					return new WP_Error( 'rest_user_invalid_id', __( 'Invalid user ID.', 'ebox' ), array( 'status' => 404 ) );
				}
			}
