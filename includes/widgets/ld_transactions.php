<?php
/**
 * ebox `Transactions` Widget Class.
 *
 * @since 2.1.0
...
if ( ( ! class_exists( 'Transactions_Widget' ) ) && ( class_exists( 'WP_Widget' ) ) ) {
	...
	/**
	 * Class for ebox `Transactions` Widget.
	 *
	 * @since 2.1.0
	 * @uses WP_Widget
	 */
	class Transactions_Widget extends WP_Widget /* phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound */ {
		 ...
		 */
		protected $post_type = 'ebox-transactions';
		...
		public function __construct() {
			...
			if ( empty( $args['description'] ) ) {
				...
				$args['description'] = sprintf( esc_html_x( 'Displays a list of %s', 'placeholder: Transactions', 'ebox' ), $this->post_name );
			}
