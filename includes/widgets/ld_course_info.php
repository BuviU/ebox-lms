...
if ( ( ! class_exists( 'ebox_Course_Info_Widget' ) ) && ( class_exists( 'WP_Widget' ) ) ) {

	/**
	 * Class for ebox `Course Info` Widget.
	 *
	 * @since 2.1.0
	 * @uses WP_Widget
	 */
	class ebox_Course_Info_Widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops  = array(
				...
				'description' => sprintf( esc_html_x( 'ebox - %s attempt and score information of users. Visible only to users logged in.', 'placeholder: Course', 'ebox' ), ebox_Custom_Label::get_label( 'course' ) ),
			);
			$control_ops = array();
			// translators: placeholder: Course.
			parent::__construct( 'ldcourseinfo', sprintf( esc_html_x( '%s Information', 'placeholder: Course', 'ebox' ), ebox_Custom_Label::get_label( 'course' ) ), $widget_ops, $control_ops );
		}
		...
		public function widget( $args, $instance ) {
			...
			$courseinfo = ebox_course_info( $user_id, $instance );
		...
		public function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php echo esc_html__( 'Title:', 'ebox' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'registered_show_thumbnail' ) ); ?>"><?php echo esc_html__( 'Registered show thumbnail:', 'ebox' ); ?></label>
				<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'registered_show_thumbnail' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'registered_show_thumbnail' ) ); ?>">
					<option value="" <?php selected( $registered_show_thumbnail, '' ); ?>><?php echo esc_html__( 'Yes (default)', 'ebox' ); ?></option>
					<option value="false" <?php selected( $registered_show_thumbnail, 'false' ); ?>><?php echo esc_html__( 'No', 'ebox' ); ?></option>
				</select>
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'registered_num' ) ); ?>"><?php echo esc_html__( 'Registered per page:', 'ebox' ); ?></label>
				...
				printf(
					...
					esc_html_x( 'Default is %d. Set to zero for no pagination.', 'placeholder: default per page', 'ebox' ),
					esc_html( ebox_Settings_Section::get_section_setting( 'ebox_Settings_Section_General_Per_Page', 'per_page' ) )
				);
				?>
				</span>
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'registered_orderby' ) ); ?>"><?php echo esc_html__( 'Registered order by:', 'ebox' ); ?></label>
				<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'registered_orderby' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'registered_orderby' ) ); ?>">
					<option value="" <?php selected( $registered_orderby, '' ); ?>><?php echo esc_html__( 'Title (default) - Order by post title', 'ebox' ); ?></option>
					<option value="id" <?php selected( $registered_orderby, 'id' ); ?>><?php echo esc_html__( 'ID - Order by post id', 'ebox' ); ?></option>
					<option value="date" <?php selected( $registered_orderby, 'date' ); ?>><?php echo esc_html__( 'Date - Order by post date', 'ebox' ); ?></option>
					<option value="menu_order" <?php selected( $registered_orderby, 'menuorder' ); ?>><?php echo esc_html__( 'Menu - Order by Page Order Value', 'ebox' ); ?></option>
				</select>
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'registered_order' ) ); ?>"><?php echo esc_html__( 'Registered order:', 'ebox' ); ?></label>
				<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'registered_order' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'registered_order' ) ); ?>">
					<option value="" <?php selected( $registered_order, '' ); ?>><?php echo esc_html__( 'ASC (default) - lowest to highest values', 'ebox' ); ?></option>
					<option value="DESC" <?php selected( $registered_order, 'DESC' ); ?>><?php echo esc_html__( 'DESC - highest to lowest values', 'ebox' ); ?></option>
				</select>
			</p>
			<p>
				...
				<?php
					echo sprintf(
						// translators: placeholder: Course.
						esc_html_x( '%s progress per page:', 'placeholder: Course', 'ebox' ),
				...
				printf(
					// translators: placeholder: default per page.
					esc_html_x( 'Default is %d. Set to zero for no pagination.', 'placeholder: default per page', 'ebox' ),
					esc_html( ebox_Settings_Section::get_section_setting( 'ebox_Settings_Section_General_Per_Page', 'progress_num' ) )
				);
				?>
				</span>
			</p>
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'progress_orderby' ) ); ?>"><?php echo esc_html__( 'Progress order by:', 'ebox' ); ?></label>
					<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'progress_orderby' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'progress_orderby' ) ); ?>">
						<option value="" <?php selected( $progress_orderby, '' ); ?>><?php echo esc_html__( 'Title (default) - Order by post title', 'ebox' ); ?></option>
						<option value="id" <?php selected( $progress_orderby, 'id' ); ?>><?php echo esc_html__( 'ID - Order by post id', 'ebox' ); ?></option>
						<option value="date" <?php selected( $progress_orderby, 'date' ); ?>><?php echo esc_html__( 'Date - Order by post date', 'ebox' ); ?></option>
						<option value="menu_order" <?php selected( $progress_orderby, 'menu_order' ); ?>><?php echo esc_html__( 'Menu - Order by Page Order Value', 'ebox' ); ?></option>
					</select>
				</p>
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'progress_order' ) ); ?>"><?php echo esc_html__( 'Progress order:', 'ebox' ); ?></label>
					<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'progress_order' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'progress_order' ) ); ?>">
						<option value="" <?php selected( $progress_order, '' ); ?>><?php echo esc_html__( 'ASC (default) - lowest to highest values', 'ebox' ); ?></option>
						<option value="DESC" <?php selected( $progress_order, 'DESC' ); ?>><?php echo esc_html__( 'DESC - highest to lowest values', 'ebox' ); ?></option>
					</select>
				</p>
				...
				<p>
					...
					printf(
						// translators: placeholder: default per page.
						esc_html_x( 'Default is %d. Set to zero for no pagination.', 'placeholder: default per page', 'ebox' ),
						esc_html( ebox_Settings_Section::get_section_setting( 'ebox_Settings_Section_General_Per_Page', 'quiz_num' ) )
					);
					?>
					</span>
				</p>
				<p>
					...
					echo sprintf(
						// translators: placeholder: Quizzes.
						esc_html_x( '%s order by:', 'placeholder: Quizzes', 'ebox' ),
						ebox_Custom_Label::get_label( 'Quizzes' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
					);
					?>
					</label>
					<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'quiz_orderby' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'quiz_orderby' ) ); ?>">
						<option value="" <?php selected( $quiz_orderby, '' ); ?>><?php echo esc_html__( 'Date Taken (default) - Order by date taken', 'ebox' ); ?></option>
						<option value="title" <?php selected( $quiz_orderby, 'title' ); ?>><?php echo esc_html__( 'Title - Order by post title', 'ebox' ); ?></option>
						<option value="id" <?php selected( $quiz_orderby, 'id' ); ?>><?php echo esc_html__( 'ID - Order by post id', 'ebox' ); ?></option>
						<option value="date" <?php selected( $quiz_orderby, 'date' ); ?>><?php echo esc_html__( 'Date - Order by post date', 'ebox' ); ?></option>
						<option value="menu_order" <?php selected( $quiz_orderby, 'menu_order' ); ?>><?php echo esc_html__( 'Menu - Order by Page Order Value', 'ebox' ); ?></option>
					</select>
				</p>
				<p>
					...
					echo sprintf(
						// translators: placeholder: Quizzes.
						esc_html_x( '%s order:', 'placeholder: Quizzes', 'ebox' ),
						ebox_Custom_Label::get_label( 'Quizzes' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
					);
					?>
					</label>
					<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'quiz_order' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'quiz_order' ) ); ?>">
						<option value="" <?php selected( $quiz_order, '' ); ?>><?php echo esc_html__( 'DESC (default) - highest to lowest values', 'ebox' ); ?></option>
						<option value="ASC" <?php selected( $quiz_order, 'ASC' ); ?>><?php echo esc_html__( 'ASC - lowest to highest values', 'ebox' ); ?></option>
					</select>
				</p>
			<?php
			return '';
	...
	add_action(
		'widgets_init',
		function() {
			return register_widget( 'ebox_Course_Info_Widget' );
		}
	);
}
