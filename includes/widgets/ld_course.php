...
if ( ( ! class_exists( 'Course_Widget' ) ) && ( class_exists( 'WP_Widget' ) ) ) {
	...
	class Course_Widget extends WP_Widget /* phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound */ {
		 ...
		 */
		protected $post_type = 'ebox-courses';
		...
		public function __construct() {
			...
			$this->post_name = ebox_Custom_Label::get_label( 'course' );

			if ( empty( $args['description'] ) ) {
				// translators: placeholder: Course.
				$args['description'] = sprintf( esc_html_x( 'Displays a list of %s', 'placeholder: Course', 'ebox' ), $this->post_name );
			}
