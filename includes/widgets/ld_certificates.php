<?php
/**
 * ebox `Certificates` Widget Class.
 *
 * @since 2.1.0
...
if ( ( ! class_exists( 'Certificates_Widget' ) ) && ( class_exists( 'WP_Widget' ) ) ) {
	...
	/**
	 * Class for ebox `Certificates` Widget.
	 *
	 * @since 2.1.0
	 * @uses WP_Widget
	 */
	class Certificates_Widget extends WP_Widget /* phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound */ {
		 ...
		 * @var string
		 */
		protected $post_type = 'ebox-certificates';
		...
		public function __construct() {
			...
			if ( empty( $args['description'] ) ) {
				$args['description'] = esc_html__( 'Displays a list of Certificates', 'ebox' );
			}
