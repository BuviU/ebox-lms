...
if (
	...
	! class_exists( 'ebox_Admin_Bulk_Edit_Action_Teams' )
) {
	/**
	 ...
	 * @since 4.2.0
	 */
	class ebox_Admin_Bulk_Edit_Action_Teams extends ebox_Admin_Bulk_Edit_Action {
		/**
		 * Team access metabox.
		 *
		 * @since 4.2.0
		 *
		 * @var ebox_Settings_Metabox_Team_Access_Settings
		 */
		 ...
		 * @since 4.2.0
		 *
		 * @param ebox_Settings_Metabox_Team_Access_Settings $metabox_access_settings Team access metabox.
		 */
		public function __construct( ebox_Settings_Metabox_Team_Access_Settings $metabox_access_settings ) {
		...
		public function get_tab_name(): string {
			return ebox_Custom_Label::get_label( 'teams' );
		}
		...
		protected function init_filters(): void {
			$team_label = ebox_Custom_Label::get_label( LDLMS_Post_Types::GROUP );
			...
			$access_modes = array();
			foreach ( $access_settings_metabox_fields['team_price_type']['args']['options'] as $option_name => $option ) {
