<?php
/**
 * ebox Admin Filter Meta Select Ajax.
 *
 * @since 4.2.0
 *
...
if (
	...
	! class_exists( 'ebox_Admin_Filter_Meta_Select_Ajax' )
) {
	/**
	 ...
	 * @since 4.2.0
	 */
	class ebox_Admin_Filter_Meta_Select_Ajax extends ebox_Admin_Filter_Meta {
		/**
