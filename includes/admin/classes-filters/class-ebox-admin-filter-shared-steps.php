<?php
/**
 * ebox Admin Filter Shared Steps.
 *
 * @since 4.2.0
 *
...
if (
	...
	! class_exists( 'ebox_Admin_Filter_Shared_Steps' )
) {
	/**
	 ...
	 * @since 4.2.0
	 */
	class ebox_Admin_Filter_Shared_Steps extends ebox_Admin_Filter_Meta {
		/**
		...
		public function __construct( array $ajax_query_data ) {
			...
			parent::__construct( 'ld_course_', ebox_Custom_Label::get_label( 'course' ) );
		}
