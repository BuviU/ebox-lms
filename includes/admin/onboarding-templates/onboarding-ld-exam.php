...
namespace ebox\Views\Onboarding;

use ebox_Custom_Label;
	...
	<div class="ld-onboarding-main">
		...
		<h2>
			...
			printf(
				...
				esc_html_x( 'You don\'t have any %s yet', 'placeholder: exams', 'ebox' ),
				ebox_get_custom_label( 'exams' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
			);
			?>
		</h2>
		<p>
		...
		<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=' . ebox_get_post_type_slug( 'exam' ) ) ); ?>" class="button button-secondary">
			<span class="dashicons dashicons-plus-alt"></span>
			<?php
			printf(
				// translators: placeholder: Exam.
				esc_html_x( 'Add your first %s', 'placeholder: Exam', 'ebox' ),
				ebox_get_custom_label( 'exam' ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Method escapes output
			);
			?>
		</a>
