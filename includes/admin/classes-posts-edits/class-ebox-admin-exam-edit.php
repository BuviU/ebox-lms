<?php
/**
 * ebox Admin Exam Edit.
 *
 * @since 4.0.0
 * @package ebox\Exam\Edit
 */
...
if ( ( class_exists( 'ebox_Admin_Post_Edit' ) ) && ( ! class_exists( 'ebox_Admin_Exam_Edit' ) ) ) {

	/**
	 * Class ebox Admin Exam Edit.
	 *
	 * @since 4.0.0
	 * @uses ebox_Admin_Post_Edit
	 */
	class ebox_Admin_Exam_Edit extends ebox_Admin_Post_Edit {
		...
		public function on_load() {
			if ( $this->post_type_check() ) {
				require_once ebox_LMS_PLUGIN_DIR . 'includes/settings/settings-metaboxes/class-ld-settings-metabox-exam-display-content.php';
