<?php
/**
 * ebox Admin Lesson Edit.
 *
 * @since 2.6.0
 * @package ebox\Lesson\Edit
 */
...
if ( ( class_exists( 'ebox_Admin_Post_Edit' ) ) && ( ! class_exists( 'ebox_Admin_Lesson_Edit' ) ) ) {

	/**
	 * Class ebox Admin Lesson Edit.
	 *
	 * @since 2.6.0
	 * @uses ebox_Admin_Post_Edit
	 */
	class ebox_Admin_Lesson_Edit extends ebox_Admin_Post_Edit {
