<?php
/**
 * ebox Admin Coupon Edit.
 *
 * @since 4.1.0
 * @package ebox\Coupon\Edit
 */
...
if (
	class_exists( 'ebox_Admin_Post_Edit' ) &&
	! class_exists( 'ebox_Admin_Coupon_Edit' )
) {
	/**
	 * Class ebox Admin Coupon Edit.
	 *
	 * @since 4.1.0
	 * @uses ebox_Admin_Post_Edit
	 */
	class ebox_Admin_Coupon_Edit extends ebox_Admin_Post_Edit {
		/**
		...
		public function __construct() {
			$this->post_type = ebox_get_post_type_slug(
		...
		public function on_load() {
			if ( $this->post_type_check() ) {
				require_once ebox_LMS_PLUGIN_DIR . 'includes/settings/settings-metaboxes/class-ld-settings-metabox-coupon-settings.php';
