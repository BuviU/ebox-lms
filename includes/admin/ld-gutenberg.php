...
namespace ebox\Admin\Gutenberg;
...
add_filter( 'use_block_editor_for_post_type', '\ebox\Admin\Gutenberg\disable_on_cpts', 10, 2 );
add_filter( 'gutenberg_can_edit_post_type', '\ebox\Admin\Gutenberg\disable_on_cpts', 10, 2 );
