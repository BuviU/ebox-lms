...
if (
	...
	! class_exists( 'ebox_Admin_Import_Proquiz' )
) {
	/**
	 * Class ebox Admin Import Pro Quiz.
	 *
	 * @since 4.3.0
	 */
	class ebox_Admin_Import_Proquiz extends ebox_Admin_Import {
		...
		private function import_question_media( int $question_id ): void {
			...
			$wpdb->update(
				$wpdb->prefix . 'ebox_pro_quiz_question',
