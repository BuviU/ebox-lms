<?php
/**
 * ebox Admin Import Pro Quiz Statistics.
 *
 * @since 4.3.0
 *
 * @package ebox
...
if (
	...
	! class_exists( 'ebox_Admin_Import_Proquiz_Statistics' )
) {
	/**
	 * Class ebox Admin Import Pro Quiz Statistics.
	 *
	 * @since 4.3.0
	 */
	class ebox_Admin_Import_Proquiz_Statistics extends ebox_Admin_Import {
		...
		protected function import(): void {
			...
			set_transient(
				ebox_Admin_Import::TRANSIENT_KEY_STATISTIC_REF_IDS,
