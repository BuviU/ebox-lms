<?php
/**
 * ebox Admin Import File Handler.
 *
 * @since 4.3.0
 *
 * @package ebox
...
if (
	...
	! class_exists( 'ebox_Admin_Import_File_Handler' )
) {
	/**
	 * Class ebox Admin Import File Handler.
	 *
	 * @since 4.3.0
	 */
	class ebox_Admin_Import_File_Handler extends ebox_Admin_Import_Export_File_Handler {
		const IMPORT_DIRECTORY = 'ebox' . DIRECTORY_SEPARATOR . 'import';
		...
		public function get_items( string $file_path ): Generator {
			...
			while ( false !== ( $line = fgets( $file ) ) ) {
				 ...
				 */
				yield apply_filters( 'ebox_import_decoded_file_line_data', $decoded_line, $file_path );
			}
