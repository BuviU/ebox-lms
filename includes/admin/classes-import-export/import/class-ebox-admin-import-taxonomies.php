...
if (
	...
	! class_exists( 'ebox_Admin_Import_Taxonomies' )
) {
	/**
	 * Class ebox Admin Import Taxonomies.
	 *
	 * @since 4.3.0
	 */
	class ebox_Admin_Import_Taxonomies extends ebox_Admin_Import {
