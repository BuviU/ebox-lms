...
if (
	...
	! class_exists( 'ebox_Admin_Import_Settings' )
) {
	/**
	 ...
	 * @since 4.3.0
	 */
	class ebox_Admin_Import_Settings extends ebox_Admin_Import {
		...
		protected function import(): void {
			...
			foreach ( $sections as $section ) {
				...
				ebox_Settings_Section::set_section_settings_all( $section['name'], $section['fields'] );
		...
		protected function map_field_value( string $section_name, string $field_key, $field_value ) {
			...
			if ( 'ebox_Settings_Section_Registration_Pages' === $section_name ) {
