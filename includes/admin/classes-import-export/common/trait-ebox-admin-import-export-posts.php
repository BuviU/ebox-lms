<?php
/**
 * ebox Admin Import/Export Posts.
 *
 * @since 4.3.0
 *
 * @package ebox
...
if ( ! trait_exists( 'ebox_Admin_Import_Export_Posts' ) ) {
	/**
	 * Trait ebox Admin Import/Export Posts.
	 *
	 * @since 4.3.0
	 */
	trait ebox_Admin_Import_Export_Posts {
		/**
		 * Post Type.
		 *
		 * @since 4.3.0
		...
		/**
		 * Returns the list of ebox settings fields that can contains media.
		 *
		 * @since 4.3.0
		 *
		 * @return array The list of ebox settings fields that can contains media.
		 */
		protected function get_ebox_fields_with_media(): array {
