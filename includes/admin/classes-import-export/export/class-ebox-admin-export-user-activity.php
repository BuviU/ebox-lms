<?php
/**
 * ebox Admin Export User Activity.
 *
 * @since 4.3.0
 *
 * @package ebox
...
if (
	...
	! class_exists( 'ebox_Admin_Export_User_Activity' )
) {
	/**
	 * Class ebox Admin Export User Activity.
	 *
	 * @since 4.3.0
	 */
	class ebox_Admin_Export_User_Activity extends ebox_Admin_Export_Chunkable {
		...
		public function get_data(): string {
			...
			foreach ( $user_activities as $user_activity ) {
				$user_activity['activity_meta'] = ebox_get_activity_meta_fields( $user_activity['activity_id'] );
				 ...
				 */
				$user_activity = apply_filters( 'ebox_export_user_activity_object', $user_activity );
