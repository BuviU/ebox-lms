...
if (
	 ...
	 * @since 4.3.0
	 */
	abstract class ebox_Admin_Export_Chunkable extends ebox_Admin_Export {
		...
		protected function get_chunk_size_rows( $chunk_size = null ): int {
			 ...
			 */
			return (int) apply_filters( 'ebox_export_chunk_size_rows', static::CHUNK_SIZE_ROWS );
		}
		...
		protected function get_chunk_size_media(): int {
			 ...
			 * @return int Chunk size.
			 */
			return (int) apply_filters( 'ebox_export_chunk_size_media', static::CHUNK_SIZE_MEDIA );
		}
