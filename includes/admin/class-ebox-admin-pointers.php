			...
			if ( 'new' === $ld_prior_version ) {
				if ( ! isset( $pointers['ebox-new-install'] ) ) {
					...
					$pointers['ebox-new-install'] = array(
						...
						'title'    => '<span id="ld-pointer-title-ebox-new-install" class="ld-pointer-title">' . esc_html__( 'First time using Ebox LMS by AT Fusion?', 'ebox' ) . '</span>',
						'content'  => '<span class="ld-pointer-content">' . sprintf(
							// translators: placeholder: Link to Setup page.
							esc_html_x( 'Go to the Ebox LMS by AT Fusion %s', 'placeholder: Link to Setup page', 'ebox' ),
