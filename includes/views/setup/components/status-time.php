...
<div class="status-wrapper">
	<span class="status time">
		...
		<span class="text"><?php printf( esc_html_x( '%d Minutes', 'Number of minutes', 'ebox' ), esc_html( $step['time_in_minutes'] ) ); ?></span>
		<span class="icon">
			<?php
			...
			$icon_svg = file_get_contents( ebox_LMS_PLUGIN_DIR . '/assets/images/time.svg' );
