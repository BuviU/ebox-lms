...
<div class="overview-wrapper">
	<div class="welcome-to-ebox">
		<p>
			Just getting started with ebox? Find out more about what features we offer in the link to our documentation below:
		</p>
		<p>
			<br /><a target="_blank" href="https://www.ebox.com/support/docs/core/">ebox Core</a>
		</p>
		<p>
	...
	<div class="overview">
		<div class="time"><?php esc_html_e( '2 Minutes', 'ebox' ); ?></div>
		<h2>
			<?php
				ebox_LMS::get_view(
		...
		<h4><?php esc_html_e( 'Additional Resources', 'ebox' ); ?></h4>
		<ul>
