<?php
/**
 * ebox Import User Progress
 *
 * This file contains functions to handle import of the ebox User Progress
 *
 * @package ebox\Import
 * @since 1.0.0
 */
...
if ( ( ! class_exists( 'ebox_Import_User_Progress' ) ) && ( class_exists( 'ebox_Import_Post' ) ) ) {
	/**
	 * Class to import user progress
	 */
	class ebox_Import_User_Progress extends ebox_Import_Post {
		/**
		 * Version
		 *
		 * @var string Version.
