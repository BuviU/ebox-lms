<?php
/**
 * ebox Import ebox Lesson
 *
 * This file contains functions to handle import of the ebox CPT Lesson
 *
 * @package ebox\Import
 * @since 1.0.0
 */
...
if ( ( ! class_exists( 'ebox_Import_Lesson' ) ) && ( class_exists( 'ebox_Import_Post' ) ) ) {
	/**
	 * Class to import modules.
	 */
	class ebox_Import_Lesson  extends ebox_Import_Post {
		/**
		 * Version
		 *
		 * @var string Version.
		 ...
		 */
		protected $dest_post_type = 'ebox-modules';
		 ...
		 */
		protected $source_post_type = 'ebox-modules';
