<?php
/**
 * ebox Import Quiz Questions
 *
 * This file contains functions to handle import of the ebox Quiz Questions
 *
 * @package ebox\Import
 * @since 1.0.0
 */
...
if ( ( ! class_exists( 'ebox_Import_Quiz_Question' ) ) && ( class_exists( 'ebox_Import_Post' ) ) ) {
	/**
	 * Class to import ebox Quiz Questions
	 */
	class ebox_Import_Quiz_Question extends ebox_Import_Post {
