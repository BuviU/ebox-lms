<?php
/**
 * ebox Import Topic CPT
 *
 * This file contains functions to handle import of the ebox Topic
 *
 * @package ebox\Import
 * @since 1.0.0
 */
...
if ( ( ! class_exists( 'ebox_Import_Topic' ) ) && ( class_exists( 'ebox_Import_Post' ) ) ) {
	/**
	 * Class to import topics
	 */
	class ebox_Import_Topic  extends ebox_Import_Post {
		/**
		 * Version
		 *
		 * @var string Version.
		 ...
		 */
		protected $dest_post_type = 'ebox-topic';
		 ...
		 */
		protected $source_post_type = 'ebox-topic';
