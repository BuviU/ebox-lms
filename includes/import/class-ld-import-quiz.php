<?php
/**
 * ebox Import Quiz CPT
 *
 * This file contains functions to handle import of the ebox Quiz CPT
 *
 * @package ebox\Import
 * @since 1.0.0
 */
...
if ( ( ! class_exists( 'ebox_Import_Quiz' ) ) && ( class_exists( 'ebox_Import_Post' ) ) ) {
	/**
	 * Class to import quizzes
	 */
	class ebox_Import_Quiz extends ebox_Import_Post {
		/**
		 * Version
		 *
		 * @var string Version.
		 ...
		 */
		protected $dest_post_type = 'ebox-quiz';
		 ...
		 */
		protected $source_post_type = 'ebox-quiz';
