<?php
/**
 * ebox Settings Section for Courses Taxonomies Metabox.
 *
 * @since 2.4.0
...
if ( ( class_exists( 'ebox_Settings_Section' ) ) && ( ! class_exists( 'ebox_Settings_Courses_Taxonomies' ) ) ) {
	/**
	 * Class ebox Settings Section for Courses Taxonomies Metabox.
	 *
	 * @since 2.4.0
	 */
	class ebox_Settings_Courses_Taxonomies extends ebox_Settings_Section {
		...
		protected function __construct() {
			...
			$this->setting_option_key = 'ebox_settings_courses_taxonomies';

			// This is the HTML form field prefix used.
			$this->setting_field_prefix = 'ebox_settings_courses_taxonomies';
			...
			$this->settings_section_label = sprintf(
				...
				esc_html_x( '%s Taxonomies', 'placeholder: Course', 'ebox' ),
			...
			$this->settings_section_description = sprintf(
				...
				esc_html_x( 'Control which taxonomies can be used to better organize your ebox %s.', 'placeholder: Course', 'ebox' ),
		...
		public function load_settings_fields() {
			...
			$this->setting_option_fields = array(
				'ld_course_category' => array(
					...
					'label'   => sprintf(
						// translators: placeholder: Course.
						esc_html_x( '%s Categories', 'placeholder: Course', 'ebox' ),
						ebox_get_custom_label( 'course' )
					),
					...
					'options' => array(
						...
						'yes' => sprintf(
							// translators: placeholder: Course.
							esc_html_x( 'Manage %s Categories via the Actions dropdown', 'placeholder: Course', 'ebox' ),
							ebox_get_custom_label( 'course' )
						),
					),
				),
				'ld_course_tag'      => array(
					...
					'label'   => sprintf(
						// translators: placeholder: Course.
						esc_html_x( '%s Tags', 'placeholder: Course', 'ebox' ),
					...
					'options' => array(
						...
						'yes' => sprintf(
							// translators: placeholder: Course.
							esc_html_x( 'Manage %s Tags via the Actions dropdown', 'placeholder: Course', 'ebox' ),
							ebox_get_custom_label( 'course' )
						),
					),
				),
...
add_action(
	...
	function() {
		ebox_Settings_Courses_Taxonomies::add_section_instance();
	}
);
