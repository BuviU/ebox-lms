<?php
/**
 * ebox Settings Section for Payments List Metabox.
 *
 * @since 3.6.0
...
if ( ( class_exists( 'ebox_Settings_Section' ) ) && ( ! class_exists( 'ebox_Settings_Section_Payments_List' ) ) ) {

	/**
	 * Class ebox Settings Section for Payments List Metabox.
	 *
	 * @since 3.6.0
	 */
	class ebox_Settings_Section_Payments_List extends ebox_Settings_Section {
		...
		protected function __construct() {
			...
			$this->setting_option_key = 'ebox_settings_payments_list';

			// This is the HTML form field prefix used.
			$this->setting_field_prefix = 'ebox_settings_payments_list';

			// Used within the Settings API to uniquely identify this section.
			$this->settings_section_key = 'settings_payments_list';

			// Section label/header.
			$this->settings_section_label = esc_html__( 'Payments', 'ebox' );
		...
		public function show_settings_section( $section = null ) {
			...
			<div class="ebox ebox_options">
				<table class="ebox-settings-table ebox-settings-table-payments widefat striped" cellspacing="0">
				<thead>
				<tr>
					<th class="col-name-enabled"></th>
					<th class="col-name-label"><?php esc_html_e( 'Payment type', 'ebox' ); ?></th>
				...
				if ( ! empty( $this->sub_sections ) ) {
					...
					?>
					<tr><td colspan="4"><?php esc_html_e( 'No Payment items found.', 'ebox' ); ?></td></tr>
					<?php
				}
				?>
				</tbody>
...
add_action(
	...
	function() {
		ebox_Settings_Section_Payments_List::add_section_instance();
	}
);
