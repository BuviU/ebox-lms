<?php
/**
 * ebox Settings Section for Email Team Purchase Success Metabox.
 *
 * @since 3.6.0
...
if ( ( class_exists( 'ebox_Settings_Section' ) ) && ( ! class_exists( 'ebox_Settings_Section_Emails_Team_Purchase_Success' ) ) ) {

	/**
	 * Class ebox Settings Section for Emails Team Purchase Success Metabox.
	 *
	 * @since 3.6.0
	 */
	class ebox_Settings_Section_Emails_Team_Purchase_Success extends ebox_Settings_Section {
		/**
		...
		protected function __construct() {
			...
			$this->setting_option_key = 'ebox_settings_emails_team_purchase_success';

			// This is the HTML form field prefix used.
			$this->setting_field_prefix = 'ebox_settings_emails_team_purchase_success';

			// Used within the Settings API to uniquely identify this section.
			$this->settings_section_key = 'settings_emails_team_purchase_success';
			...
			$this->settings_section_label = sprintf(
				...
				esc_html_x( '%s Purchase Success', 'Placeholder: Team', 'ebox' ),
				...
				'label_description' => '<div>
					...
					<ul>
						...
						<li><span>{post_title}</span> - ' . sprintf(
							...
							esc_html_x( '%s Title', 'placeholder: Team label', 'ebox' ),
							ebox_get_custom_label( 'team' )
						) . '</li>
						<li><span>{post_url}</span> - ' . sprintf(
							// translators: placeholder: Team label.
							esc_html_x( '%s URL', 'placeholder: Team label', 'ebox' ),
							ebox_get_custom_label( 'team' )
						) . '</li>
...
add_action(
	...
	function() {
		ebox_Settings_Section_Emails_Team_Purchase_Success::add_section_instance();
	}
);
