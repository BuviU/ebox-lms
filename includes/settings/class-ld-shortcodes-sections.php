<?php
/**
 * ebox Admin Shortcodes Section Class.
 *
 * @since 2.4.0
...
if ( ! class_exists( 'ebox_Shortcodes_Section' ) ) {

	/**
	 * Class for ebox Admin Course Edit.
	 *
	 * @since 2.4.0
	 */
	class ebox_Shortcodes_Section {
		...
		public function init_shortcodes_section_fields() {
			foreach ( $this->shortcodes_option_fields as $field_id => $setting_option_field ) {
				...
				if ( ! isset( $setting_option_field['display_callback'] ) ) {
					$display_ref = ebox_Settings_Fields::get_field_instance( $setting_option_field['type'] );
					if ( ! $display_ref ) {
		...
		public function show_section_fields() {
			...
			echo ebox_Settings_Fields::show_section_fields( $this->shortcodes_settings_fields ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Need to output HTML.
		...
		public function show_shortcodes_section_header() {
			 ...
			 */
			do_action( 'ebox_shortcodes_section_header_before_form', $this->shortcodes_section_key );

			?><form id="ebox_shortcodes_form_<?php echo esc_attr( $this->shortcodes_section_key ); ?>" class="ebox_shortcodes_form" shortcode_slug="<?php echo esc_attr( $this->shortcodes_section_key ); ?>" shortcode_type="<?php echo esc_attr( $this->shortcodes_section_type ); ?>">
				<?php
				/**
				 ...
				 * @param string $shortcodes_section_key Shortcodes section key.
				 */
				do_action( 'ebox_shortcodes_section_header_before_title', $this->shortcodes_section_key );
				?>
				 ...
				 * @param string $shortcodes_section_key Shortcodes section key.
				 */
				do_action( 'ebox_shortcodes_section_header_before_description', $this->shortcodes_section_key );
				?>
				 ...
				 * @param string $shortcodes_section_key Shortcodes section key.
				 */
				do_action( 'ebox_shortcodes_section_before_content', $this->shortcodes_section_key );
				?>
				<div class="ebox ebox_options ebox_shortcodes_section" style="clear:left">
				<?php
		}
		...
		public function show_shortcodes_section_footer() {
			?>
				 ...
				 * @param string $shortcodes_section_key Shortcodes section key.
				 */
				do_action( 'ebox_shortcodes_section_after_content', $this->shortcodes_section_key );
				?>
				 ...
				 * @param string $shortcodes_section_key Shortcodes section key.
				 */
				do_action( 'ebox_shortcodes_section_before_button', $this->shortcodes_section_key );
				?>
				<p style="clear:left"><input type="submit" class="button-primary" value="<?php esc_html_e( 'Insert Shortcode', 'ebox' ); ?>"></p>
				<?php
				/**
				 ...
				 * @param string $shortcodes_section_key Shortcodes section key.
				 */
				do_action( 'ebox_shortcodes_section_after_button', $this->shortcodes_section_key );
				?>
			</form>
			<?php
			/**
			 ...
			 * @param string $shortcodes_section_key Shortcodes section key.
			 */
			do_action( 'ebox_shortcodes_section_header_after_form', $this->shortcodes_section_key );
		}
