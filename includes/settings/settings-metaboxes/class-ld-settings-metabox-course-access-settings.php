		...
		public function load_settings_fields() {
			...
			$this->setting_option_fields = array(
				'course_price_type'             => array(
					...
					'label'   => esc_html__( 'Mode of Access', 'ebox' ),
					'type'    => 'radio',
					'value'   => $this->setting_option_values['course_price_type'],
					'default' => ebox_DEFAULT_COURSE_PRICE_TYPE,
					'options' => array(
						'free'      => array(
							'label'       => esc_html__( 'No Cost', 'ebox' ),
							'description' => sprintf(
								// translators: placeholder: course.
								esc_html_x( 'The %s is safeguarded. To access the material, enrollment and registration are necessary.
								', 'placeholder: course', 'ebox' ),
								ebox_get_custom_label_lower( 'course' )
							),
						),
						...
						'paynow'    => array(
							'label'               => esc_html__( 'Purchase Today', 'ebox' ),
							'description'         => sprintf(
								// translators: placeholder: course, course.
								esc_html_x( 'The integrated PayPal and/or Stripe security measures safeguard the %1$s. To receive access, users must pay a one-time price to purchase the course.
								', 'placeholder: course, course', 'ebox' ),
								ebox_get_custom_label_lower( 'course' ),
								ebox_get_custom_label_lower( 'course' )
							),
							'inline_fields'       => array(
						...
						'subscribe' => array(
							...
							'description'         => sprintf(
								// translators: placeholder: course, course.
								esc_html_x( 'The  integrated PayPal and/or Stripe security measures safeguard the %1$s. To obtain access, users must purchase the %2$s (a recurring charge).
								', 'placeholder: course, course', 'ebox' ),
								ebox_get_custom_label_lower( 'course' ),
								ebox_get_custom_label_lower( 'course' )
							),
						...
						'open'      => array(
							'label'       => esc_html__( 'Accessible', 'ebox' ),
							'description' => sprintf(
								// translators: placeholder: course.
								esc_html_x( 'There is no protection for the %s. Its material is accessible to all users without requiring enrollment or log-in.
								', 'placeholder: course', 'ebox' ),
								ebox_get_custom_label_lower( 'course' )
							),
						),
						...
						'closed'    => array(
							'label'               => esc_html__( 'Bolt', 'ebox' ),
							'description'         => sprintf(
								// translators: placeholder: course, team.
								esc_html_x( 'Only admin enrollment (manual), %2$s enrollment, or integration enrollment (shopping cart or membership) will grant access to the %1$s. If a URL is not supplied (optional), no enrollment button will appear.
								', 'placeholder: course', 'ebox' ),
								ebox_get_custom_label_lower( 'course' ),
