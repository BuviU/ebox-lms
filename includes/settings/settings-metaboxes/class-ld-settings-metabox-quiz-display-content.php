<?php
/**
 * ebox Settings Metabox for Quiz Display and Content Options.
 *
 * @since 3.0.0
...
if ( ( class_exists( 'ebox_Settings_Metabox' ) ) && ( ! class_exists( 'ebox_Settings_Metabox_Quiz_Display_Content' ) ) ) {
	/**
	 * Class ebox Settings Metabox for Quiz Display and Content Options.
	 *
	 * @since 3.0.0
	 */
	class ebox_Settings_Metabox_Quiz_Display_Content extends ebox_Settings_Metabox {
		...
		public function __construct() {
			...
			$this->settings_metabox_key = 'ebox-quiz-display-content-settings';
			...
			$this->settings_section_description = sprintf(
				...
				esc_html_x( 'Controls how the %s will look and what will be displayed', 'placeholder: quiz', 'ebox' ),
		...
		public function load_settings_fields() {
			...
			$this->setting_option_fields = array(
				'quizModus_single_back_button' => array(
					...
					'default'    => '',
					'options'    => array(
						'on' => esc_html__( 'Display Back button', 'ebox' ),
					),
				),
			);
			...
			$this->setting_option_fields = array(
				'quizModus_single_feedback' => array(
					...
					'options'    => array(
						'end'  => array(
							'label'               => esc_html__( 'Display results at the end only', 'ebox' ),
							'inline_fields'       => array(
						...
						'each' => array(
							'label' => esc_html__( 'Display results after each submitted answer', 'ebox' ),
						),
					),
				),
			);
			...
			$this->setting_option_fields = array(
				'quizModus_multiple_questionsPerPage' => array(
					...
					'input_label' => sprintf(
						...
						esc_html_x( '%s per page (0 = all)', 'placeholder: questions', 'ebox' ),
			...
			$this->setting_option_fields = array(
				'showMaxQuestionValue' => array(
					...
					'input_label' => sprintf(
						// translators: placeholder: questions.
						esc_html_x( 'out of %1$d %2$s.', 'placeholder: count of questions, questions label.', 'ebox' ),
			...
			$this->setting_option_fields = array(
				'quiz_materials_enabled'       => array(
					...
					'label'               => sprintf(
						// translators: placeholder: Quiz.
						esc_html_x( '%s Materials', 'placeholder: Quiz', 'ebox' ),
						ebox_get_custom_label( 'quiz' )
					),
					'help_text'           => sprintf(
						// translators: placeholder: quiz, quiz.
						esc_html_x( 'List and display support materials for the %1$s. This is visible to any user having access to the %2$s.', 'placeholder: quiz, quiz', 'ebox' ),
						ebox_get_custom_label_lower( 'quiz' ),
						ebox_get_custom_label_lower( 'quiz' )
					),
					...
					'options'             => array(
						'on' => sprintf(
							// translators: placeholder: Quiz.
							esc_html_x( 'Any content added below is displayed on the %s page', 'placeholder: Quiz', 'ebox' ),
							ebox_get_custom_label( 'quiz' )
						),
						''   => '',
					),
				...
				'autostart'                    => array(
					...
					'options' => array(
						'on' => sprintf(
							// translators: placeholder: Quiz.
							esc_html_x( 'Start automatically, without the "Start %s" button', 'placeholder: Quiz', 'ebox' ),
							ebox_get_custom_label( 'quiz' )
						),
					),
					'rest'    => array(
				...
				'quizModus'                    => array(
					...
					'label'   => sprintf(
						...
						esc_html_x( '%s Display', 'placeholder: Question', 'ebox' ),
					...
					'options' => array(
						'single'   => array(
							'label'               => sprintf(
								// translators: placeholder: question.
								esc_html_x( 'One %s at a time', 'placeholder: question', 'ebox' ),
						...
						'multiple' => array(
							'label'               => sprintf(
								// translators: placeholder: questions.
								esc_html_x( 'All %s at once (or paginated)', 'placeholder: questions', 'ebox' ),
								ebox_get_custom_label_lower( 'questions' )
							),
							'inline_fields'       => array(
				...
				'showReviewQuestion'           => array(
					...
					'label'               => sprintf(
						// translators: placeholder: Question.
						esc_html_x( '%s Overview Table', 'placeholder: Question', 'ebox' ),
						ebox_get_custom_label( 'question' )
					),
					...
					'options'             => array(
						...
						'on' => sprintf(
							...
							esc_html_x( 'An overview table will be shown for all %s.', 'placeholder: Questions', 'ebox' ),
							ebox_get_custom_label_lower( 'questions' )
						),
					),
				...
				'quizSummaryHide'              => array(
					...
					'label'          => sprintf(
						// translators: placeholder: Quiz.
						esc_html_x( '%s Summary', 'placeholder: Quiz', 'ebox' ),
						ebox_get_custom_label( 'quiz' )
					),
					...
					'options'        => array(
						''   => '',
						'on' => esc_html__( 'Display a summary table before submission', 'ebox' ),
					),
				...
				'skipQuestionDisabled'         => array(
					...
					'label'          => sprintf(
						// translators: placeholder: Question.
						esc_html_x( 'Skip %s', 'placeholder: Question', 'ebox' ),
						ebox_get_custom_label( 'question' )
					),
					...
					'help_text'      => sprintf(
						...
						esc_html_x( 'Must use the "One %1$s at a time" and "Display results after each submitted answer" settings in the %2$s Display setting above.', 'placeholders: question, question', 'ebox' ),
						ebox_get_custom_label_lower( 'question' ),
						ebox_get_custom_label( 'question' )
					),
					'rest'           => array(
				...
				'custom_sorting'               => array(
					...
					'label'               => sprintf(
						// translators: placeholder: Question.
						esc_html_x( 'Custom %s Ordering', 'placeholder: Question', 'ebox' ),
						ebox_get_custom_label( 'question' )
					),
				...
				'sortCategories'               => array(
					'name'           => 'sortCategories',
					'type'           => 'checkbox',
					'label'          => esc_html__( 'Sort by Category', 'ebox' ),
				...
				'questionRandom'               => array(
					'name'                => 'questionRandom',
					'type'                => 'checkbox-switch',
					'label'               => esc_html__( 'Randomize Order', 'ebox' ),
				...
				'showMaxQuestion'              => array(
					...
					'options'        => array(
						''   => array(
							'label' => sprintf(
								// translators: placeholder: questions.
								esc_html_x( 'Display all %s', 'placeholder: questions', 'ebox' ),
								ebox_get_custom_label_lower( 'questions' )
							),
						),
						'on' => array(
							'label'               => sprintf(
								// translators: placeholder: questions.
								esc_html_x( 'Display subset of %s', 'placeholder: questions', 'ebox' ),
								ebox_get_custom_label_lower( 'questions' )
							),
							'inline_fields'       => array(
				...
				'custom_question_elements'     => array(
					...
					'label'               => sprintf(
						// translators: placeholder: Question.
						esc_html_x( 'Additional %s Options', 'placeholder: Question', 'ebox' ),
						ebox_get_custom_label( 'question' )
					),
					...
					'options'             => array(
						...
						'on' => sprintf(
							// translators: placeholder: Question.
							esc_html_x( 'Any enabled elements below will be displayed in each %s', 'placeholder: Question', 'ebox' ),
							ebox_get_custom_label( 'question' )
						),
					),
				...
				'showPoints'                   => array(
					'name'           => 'showPoints',
					'type'           => 'checkbox-switch',
					'label'          => esc_html__( 'Point Value', 'ebox' ),
				...
				'showCategory'                 => array(
					...
					'label'          => sprintf(
						// translators: placeholder: Question.
						esc_html_x( '%s Category', 'placeholder: Question', 'ebox' ),
						ebox_get_custom_label( 'question' )
					),
				...
				'hideQuestionPositionOverview' => array(
					...
					'label'          => sprintf(
						// translators: placeholder: Question.
						esc_html_x( '%s Position', 'placeholder: Question', 'ebox' ),
						ebox_get_custom_label( 'question' )
					),
				...
				'hideQuestionNumbering'        => array(
					...
					'label'          => sprintf(
						// translators: placeholder: Question.
						esc_html_x( '%s Numbering', 'placeholder: Question', 'ebox' ),
						ebox_get_custom_label( 'question' )
					),
				...
				'numberedAnswer'               => array(
					'name'           => 'numberedAnswer',
					'type'           => 'checkbox-switch',
					'label'          => esc_html__( 'Number Answers', 'ebox' ),
				...
				'answerRandom'                 => array(
					'name'           => 'answerRandom',
					'type'           => 'checkbox-switch',
					'label'          => esc_html__( 'Randomize Answers', 'ebox' ),
					'help_text'      => sprintf(
						// translators: placeholder: question.
						esc_html_x( 'Answer display will be randomized within any given %s.', 'placeholder: question.', 'ebox' ),
						ebox_get_custom_label_lower( 'question' )
					),
				...
				'titleHidden'                  => array(
					...
					'help_text' => sprintf(
						...
						esc_html_x( 'A second %1$s title will be displayed on the %2$s Post. This option is recommended if displaying %3$s via Shortcode.', 'placeholder: quiz, Quiz, Quizzes.', 'ebox' ),
						ebox_get_custom_label_lower( 'quiz' ),
						ebox_get_custom_label( 'quiz' ),
					...
					'options'   => array(
						''   => sprintf(
							// translators: placeholder: Quiz.
							esc_html_x( 'Only the %s Post title is shown', 'placeholder: Quiz', 'ebox' ),
							ebox_get_custom_label( 'quiz' )
						),
						'on' => sprintf(
							// translators: placeholder: Quiz, Quiz, quiz.
							esc_html_x( 'The %1$s Title is displayed in addition to the %2$s Post title. Recommended for %3$s shortcode usage.', 'placeholder: Quiz, Quiz, quiz', 'ebox' ),
							ebox_get_custom_label( 'quiz' ),
							ebox_get_custom_label( 'quiz' ),
							ebox_get_custom_label_lower( 'quiz' )
						),
	...
	add_filter(
		...
		function( $metaboxes = array() ) {
			if ( ( ! isset( $metaboxes['ebox_Settings_Metabox_Quiz_Display_Content'] ) ) && ( class_exists( 'ebox_Settings_Metabox_Quiz_Display_Content' ) ) ) {
				$metaboxes['ebox_Settings_Metabox_Quiz_Display_Content'] = ebox_Settings_Metabox_Quiz_Display_Content::add_metabox_instance();
			}
