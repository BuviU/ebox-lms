<?php
/**
 * ebox Settings Metabox for Topic Display and Content Options.
 *
 * @since 3.0.0
...
if ( ( class_exists( 'ebox_Settings_Metabox' ) ) && ( ! class_exists( 'ebox_Settings_Metabox_Topic_Display_Content' ) ) ) {
	/**
	 * Class ebox Settings Metabox for Topic Display and Content Options.
	 *
	 * @since 3.0.0
	 */
	class ebox_Settings_Metabox_Topic_Display_Content extends ebox_Settings_Metabox {
		...
		public function __construct() {
			...
			$this->settings_screen_id = 'ebox-topic';

			// Used within the Settings API to uniquely identify this section.
			$this->settings_metabox_key = 'ebox-topic-display-content-settings';
			...
			$this->settings_section_description = sprintf(
				...
				esc_html_x( 'Controls the look and feel of the %s and optional content settings', 'placeholder: topic', 'ebox' ),
		...
		public function load_settings_fields() {
			...
			$this->setting_option_fields = array(
				'lesson_video_auto_complete'        => array(
					...
					'label'     => sprintf(
						// translators: placeholder: Topic.
						esc_html_x( '%s auto-completion', 'placeholder: Topic', 'ebox' ),
					...
					'help_text' => sprintf(
						// translators: placeholder: topic.
						esc_html_x( ' Automatically mark the %s as completed once the user has watched the full video.', 'placeholder: topic', 'ebox' ),
						ebox_get_custom_label_lower( 'topic' )
					),
					'rest'      => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Video Auto-complete', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'boolean',
								'default'     => false,
							),
						),
				...
				'lesson_video_auto_complete_delay'  => array(
					...
					'help_text'   => sprintf(
						// translators: placeholder: topic.
						esc_html_x( 'Specify a delay between video completion and %s completion.', 'placeholder: topic', 'ebox' ),
						ebox_get_custom_label_lower( 'topic' )
					),
					'rest'        => array(
						'show_in_rest' => ebox_REST_API::enabled(),
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Video Completion Delay (seconds).', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'integer',
								'default'     => 0,
							),
						),
					...
					'rest'      => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Video Show Mark Complete Button', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'boolean',
								'default'     => false,
							),
						),
				...
				'assignment_upload_limit_count'      => array(
					...
					'rest'        => array(
						...
						'rest_args'    => array(
							'schema' => array(
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Assignment Upload Count Limit.', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'integer',
								'default'     => 0,
							),
						),
					...
					'rest'      => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Assignment Allow File Deletion.', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'boolean',
								'default'     => false,
							),
						),
			...
			$this->setting_option_fields = array(
				'topic_materials_enabled'            => array(
					...
					'label'               => sprintf(
						// translators: placeholder: Topic.
						esc_html_x( '%s Materials', 'placeholder: Topic', 'ebox' ),
						ebox_get_custom_label( 'topic' )
					),
					'help_text'           => sprintf(
						// translators: placeholder: topic, topic.
						esc_html_x( 'List and display support materials for the %1$s. This is visible to any user having access to the %2$s.', 'placeholder: topic, topic', 'ebox' ),
						ebox_get_custom_label_lower( 'topic' ),
						ebox_get_custom_label_lower( 'topic' )
					),
					...
					'options'             => array(
						'on' => sprintf(
							// translators: placeholder: topic.
							esc_html_x( 'Any content added below is displayed on the %s page', 'placeholder: topic', 'ebox' ),
							ebox_get_custom_label_lower( 'topic' )
						),
						''   => '',
					),
				...
				'lesson_video_enabled'               => array(
					...
					'options'             => array(
						...
						'on' => array(
							...
							'tooltip'     => sprintf(
								// translators: placeholder: Topic.
								esc_html_x( 'Cannot be enabled while %s timer or Assignments are enabled', 'placeholder: Topic', 'ebox' ),
								ebox_get_custom_label( 'topic' )
							),
						),
					),
					...
					'rest'                => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Video Progression Enabled', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'boolean',
								'default'     => false,
							),
						),
					...
					'rest'           => array(
						...
						'rest_args'    => array(
							'schema' => array(
								'field_key'   => 'video_url',
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Video Progression URL', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'text',
								'default'     => '',
							),
						),
				...
				'lesson_video_shown'                 => array(
					...
					'options'        => array(
						'BEFORE' => array(
							...
							'description' => sprintf(
								// translators: placeholder: topic.
								esc_html_x( 'The video will be shown and must be fully watched before the user can access the %s’s associated steps.', 'placeholder: topic', 'ebox' ),
								ebox_get_custom_label_lower( 'topic' )
							),
						),
						'AFTER'  => array(
							...
							'description'         => sprintf(
								// translators: placeholder: topic, topic.
								esc_html_x( 'The video will be visible after the user has completed the %1$s’s associated steps. The full video must be watched in order to complete the %2$s.', 'placeholder: topic, topic', 'ebox' ),
								ebox_get_custom_label_lower( 'topic' ),
								ebox_get_custom_label_lower( 'topic' )
							),
							'inline_fields'       => array(
					...
					'rest'           => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Video Shown before or after sub-steps', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'default'     => 'BEFORE',
								'type'        => 'string',
								'enum'        => array(
									'BEFORE',
					...
					'rest'           => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Video Autostart', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'boolean',
								'default'     => false,
							),
						),
				...
				'lesson_video_show_controls'         => array(
					...
					'type'           => 'checkbox-switch',
					'help_text'      => esc_html__( 'Only available for YouTube and local videos.', 'ebox' ),
					...
					'rest'           => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Video Controls Display. YouTube and local videos only', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'boolean',
								'default'     => false,
							),
						),
				...
				'lesson_assignment_upload'           => array(
					...
					'options'             => array(
						'on' => array(
							...
							'tooltip'     => sprintf(
								// translators: placeholder: topic.
								esc_html_x( 'Cannot be enabled while %s timer or Video progression are enabled', 'placeholder: topic', 'ebox' ),
								ebox_get_custom_label_lower( 'topic' )
							),
						),
					),
					...
					'rest'                => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Assignment Uploads Enabled', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'boolean',
								'default'     => false,
							),
						),
				...
				'assignment_upload_limit_extensions' => array(
					...
					'rest'           => array(
						...
						'rest_args'    => array(
							'schema' => array(
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Assignment Allowed file extensions. Comma separated pdf, xls, zip', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'text',
								'default'     => '',
							),
						),
				...
				'assignment_upload_limit_size'       => array(
					...
					'help_text'      => sprintf(
						...
						esc_html_x( 'Default maximum file size supported is: %s', 'placeholder: PHP file upload size', 'ebox' ),
					...
					'rest'           => array(
						...
						'rest_args'    => array(
							'schema' => array(
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%1$s Assignment Upload size limit. Max per server is %2$s ', 'placeholder: Topic, Upload size limit', 'ebox' ), ebox_get_custom_label( 'topic' ), ini_get( 'upload_max_filesize' ) ),
								'type'        => 'text',
								'default'     => '',
							),
						),
					...
					'rest'                => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Assignment Points Enabled', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'boolean',
								'default'     => false,
							),
						),
					...
					'rest'           => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Assignment Points Amount', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'integer',
								'default'     => 0,
							),
						),
				...
				'auto_approve_assignment'            => array(
					...
					'options'        => array(
						...
						''   => array(
							...
							'description'         => sprintf(
								// translators: placeholder: Team, topic.
								esc_html_x( 'Admin or %1$s leader approval and grading required. The %2$s cannot be completed until the assignment is approved.', 'placeholder: Team, topic', 'ebox' ),
					...
					'rest'           => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Assignment Auto-approve Enabled', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'boolean',
								'default'     => true,
							),
						),
				...
				'forced_lesson_time_enabled'         => array(
					...
					'label'               => sprintf(
						// translators: placeholder: Topic.
						esc_html_x( '%s Timer', 'placeholder: Topic', 'ebox' ),
						ebox_get_custom_label( 'topic' )
					),
					'default'             => '',
					'type'                => 'checkbox-switch',
					...
					'help_text'           => sprintf(
						// translators: placeholder: topic.
						esc_html_x( 'The %s cannot be marked as completed until the set time has elapsed.', 'placeholder: topic', 'ebox' ),
						ebox_get_custom_label_lower( 'topic' )
					),
					'options'             => array(
						'on' => array(
					...
					'rest'                => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Time Enabled', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'boolean',
								'default'     => false,
							),
						),
					...
					'rest'           => array(
						...
						'rest_args'    => array(
							'schema' => array(
								...
								// translators: placeholder: Topic.
								'description' => sprintf( esc_html_x( '%s Timer Amount.', 'placeholder: Topic', 'ebox' ), ebox_get_custom_label( 'topic' ) ),
								'type'        => 'integer',
								'default'     => 0,
							),
						),
	...
	add_filter(
		'ebox_post_settings_metaboxes_init_' . ebox_get_post_type_slug( 'topic' ),
		function( $metaboxes = array() ) {
			if ( ( ! isset( $metaboxes['ebox_Settings_Metabox_Topic_Display_Content'] ) ) && ( class_exists( 'ebox_Settings_Metabox_Topic_Display_Content' ) ) ) {
				$metaboxes['ebox_Settings_Metabox_Topic_Display_Content'] = ebox_Settings_Metabox_Topic_Display_Content::add_metabox_instance();
			}
