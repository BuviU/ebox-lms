<?php
/**
 * ebox Shortcode Section for Topics List [ld_topic_list].
 *
 * @since 2.4.0
...
if ( ( class_exists( 'ebox_Shortcodes_Section' ) ) && ( ! class_exists( 'ebox_Shortcodes_Section_ld_topic_list' ) ) ) {
	/**
	 * Class ebox Shortcode Section for Topics List [ld_topic_list].
	 *
	 * @since 2.4.0
	 */
	class ebox_Shortcodes_Section_ld_topic_list extends ebox_Shortcodes_Section /* phpcs:ignore PEAR.NamingConventions.ValidClassName.Invalid */ {
		...
		public function __construct( $fields_args = array() ) {
			...
			$this->shortcodes_section_title = sprintf( esc_html_x( '%s List', 'placeholder: Topic', 'ebox' ), ebox_Custom_Label::get_label( 'topic' ) );
			$this->shortcodes_section_type  = 1;
			// translators: placeholders: topics, topics (URL slug).
			$this->shortcodes_section_description = sprintf( wp_kses_post( _x( 'This shortcode shows list of %1$s. You can use this shortcode on any page if you do not want to use the default <code>/%2$s/</code> page.', 'placeholders: topics, topics (URL slug)', 'ebox' ) ), ebox_get_custom_label_lower( 'topics' ), ebox_Settings_Section::get_section_setting( 'ebox_Settings_Section_Permalinks', 'topics' ) );
		...
		public function init_shortcodes_section_fields() {
			$this->shortcodes_option_fields = array(
				...
				'lesson_id'      => array(
					...
					// translators: placeholders: Lesson, modules, Course.
					'help_text' => sprintf( esc_html_x( 'Must be used with course_id. Enter single %1$s ID. Leave blank for all %2$s within %3$s.', 'placeholders: Lesson, modules, Course', 'ebox' ), ebox_Custom_Label::get_label( 'lesson' ), ebox_Custom_Label::get_label( 'modules' ), ebox_Custom_Label::get_label( 'lesson' ) ),
					'value'     => '',
					'class'     => 'small-text',
				),
				...
				'num'            => array(
					...
					'label'     => sprintf( esc_html_x( '%s Per Page', 'placeholder: Topics', 'ebox' ), ebox_Custom_Label::get_label( 'topics' ) ),
					// translators: placeholders: Topics, default per page.
					'help_text' => sprintf( esc_html_x( '%1$s per page. Default is %2$d. Set to zero for all.', 'placeholders: Topics, default per page', 'ebox' ), ebox_Custom_Label::get_label( 'topics' ), ebox_Settings_Section::get_section_setting( 'ebox_Settings_Section_General_Per_Page', 'per_page' ) ),
					'value'     => '',
					'class'     => 'small-text',
					'attrs'     => array(
						'min'  => 0,
				...
				'show_content'   => array(
					...
					'type'      => 'select',
					// translators: placeholder: Topic.
					'label'     => sprintf( esc_html_x( 'Show %s Content', 'placeholder: Topic', 'ebox' ), ebox_Custom_Label::get_label( 'topic' ) ),
					// translators: placeholder: topics.
					'help_text' => sprintf( esc_html_x( 'shows %s content.', 'placeholder: topic', 'ebox' ), ebox_get_custom_label_lower( 'topic' ) ),
					'value'     => 'true',
					'options'   => array(
				...
				'show_thumbnail' => array(
					...
					'type'      => 'select',
					// translators: placeholder: Topic.
					'label'     => sprintf( esc_html_x( 'Show %s Thumbnail', 'placeholder: Topic', 'ebox' ), ebox_Custom_Label::get_label( 'topic' ) ),
					// translators: placeholder: topic.
					'help_text' => sprintf( esc_html_x( 'shows a %s thumbnail.', 'placeholder: topic', 'ebox' ), ebox_get_custom_label_lower( 'topic' ) ),
					'value'     => 'true',
					'options'   => array(
						''      => esc_html__( 'Yes (default)', 'ebox' ),
						'false' => esc_html__( 'No', 'ebox' ),
			...
			if ( defined( 'ebox_COURSE_GRID_FILE' ) ) {
				$this->shortcodes_option_fields['col'] = array(
					...
					// translators: placeholder: course.
					'help_text' => sprintf( esc_html_x( 'number of columns to show when using %s grid addon', 'placeholders: course', 'ebox' ), ebox_get_custom_label_lower( 'course' ) ),
					'value'     => '',
					'class'     => 'small-text',
				);
			}
			...
			if ( ebox_Settings_Section::get_section_setting( 'ebox_Settings_Topics_Taxonomies', 'ld_topic_category' ) == 'yes' ) {
				$this->shortcodes_option_fields['topic_cat'] = array(
					...
					'type'      => 'number',
					// translators: placeholder: Topic.
					'label'     => sprintf( esc_html_x( '%s Category ID', 'placeholder: Topics', 'ebox' ), ebox_Custom_Label::get_label( 'topic' ) ),
					// translators: placeholder: topics.
					'help_text' => sprintf( esc_html_x( 'shows %s with mentioned category id.', 'placeholder: topics', 'ebox' ), ebox_get_custom_label_lower( 'topics' ) ),
					'value'     => '',
					'class'     => 'small-text',
				);
				...
				$this->shortcodes_option_fields['topic_category_name'] = array(
					...
					'type'      => 'text',
					// translators: placeholder: Topic.
					'label'     => sprintf( esc_html_x( '%s Category Slug', 'placeholder: Topic', 'ebox' ), ebox_Custom_Label::get_label( 'topic' ) ),
					// translators: placeholder: topics.
					'help_text' => sprintf( esc_html_x( 'shows %s with mentioned category slug.', 'placeholder: topics', 'ebox' ), ebox_get_custom_label_lower( 'topics' ) ),
					'value'     => '',
				);
				...
				$this->shortcodes_option_fields['topic_categoryselector'] = array(
					...
					'type'      => 'checkbox',
					// translators: placeholder: Topic.
					'label'     => sprintf( esc_html_x( '%s Category Selector', 'placeholder: Topic', 'ebox' ), ebox_Custom_Label::get_label( 'topic' ) ),
					// translators: placeholder: topic.
					'help_text' => sprintf( esc_html_x( 'shows a %s category dropdown.', 'placeholder: topic', 'ebox' ), ebox_get_custom_label_lower( 'topic' ) ),
					'value'     => '',
					'options'   => array(
			...
			if ( ebox_Settings_Section::get_section_setting( 'ebox_Settings_Topics_Taxonomies', 'ld_topic_tag' ) == 'yes' ) {
				$this->shortcodes_option_fields['topic_tag_id'] = array(
					...
					'type'      => 'number',
					// translators: placeholder: Topic.
					'label'     => sprintf( esc_html_x( '%s Tag ID', 'placeholder: Topic', 'ebox' ), ebox_Custom_Label::get_label( 'topic' ) ),
					// translators: placeholder: topics.
					'help_text' => sprintf( esc_html_x( 'shows %s with mentioned tag id.', 'placeholder: topics', 'ebox' ), ebox_get_custom_label_lower( 'topics' ) ),
					'value'     => '',
					'class'     => 'small-text',
				);
				...
				$this->shortcodes_option_fields['topic_tag'] = array(
					...
					'type'      => 'text',
					// translators: placeholder: Topic.
					'label'     => sprintf( esc_html_x( '%s Tag Slug', 'placeholder: Topic', 'ebox' ), ebox_Custom_Label::get_label( 'topic' ) ),
					// translators: placeholder: topics.
					'help_text' => sprintf( esc_html_x( 'shows %s with mentioned tag slug.', 'placeholder: topics', 'ebox' ), ebox_get_custom_label_lower( 'topics' ) ),
					'value'     => '',
				);
			...
			if ( ebox_Settings_Section::get_section_setting( 'ebox_Settings_Topics_Taxonomies', 'wp_post_category' ) == 'yes' ) {
				...
				$this->shortcodes_option_fields['cat'] = array(
					...
					// translators: placeholder: topics.
					'help_text' => sprintf( esc_html_x( 'shows %s with mentioned WP category id.', 'placeholder: topics', 'ebox' ), ebox_get_custom_label_lower( 'topics' ) ),
					'value'     => '',
					'class'     => 'small-text',
				);
				...
				$this->shortcodes_option_fields['category_name'] = array(
					...
					// translators: placeholder: topics.
					'help_text' => sprintf( esc_html_x( 'shows %s with mentioned WP category slug.', 'placeholder: topics', 'ebox' ), ebox_get_custom_label_lower( 'topics' ) ),
					'value'     => '',
				);
			...
			if ( ebox_Settings_Section::get_section_setting( 'ebox_Settings_Topics_Taxonomies', 'wp_post_tag' ) == 'yes' ) {
				$this->shortcodes_option_fields['tag'] = array(
					...
					// translators: placeholder: topics.
					'help_text' => sprintf( esc_html_x( 'shows %s with mentioned WP tag slug.', 'placeholder: topics', 'ebox' ), ebox_get_custom_label_lower( 'topics' ) ),
					'value'     => '',
				);
				...
				$this->shortcodes_option_fields['tag_id'] = array(
					...
					// translators: placeholder: topics.
					'help_text' => sprintf( esc_html_x( 'shows %s with mentioned WP tag id.', 'placeholder: topics', 'ebox' ), ebox_get_custom_label_lower( 'topics' ) ),
					'value'     => '',
					'class'     => 'small-text',
				);
			}
