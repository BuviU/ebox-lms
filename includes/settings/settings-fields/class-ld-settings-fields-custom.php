...
if ( ( class_exists( 'ebox_Settings_Fields' ) ) && ( ! class_exists( 'ebox_Settings_Fields_Custom' ) ) ) {
	/**
	 * Class ebox Custom Settings Field.
	 *
	 * @since 3.0.0
	 * @uses ebox_Settings_Fields
	 */
	class ebox_Settings_Fields_Custom extends ebox_Settings_Fields {
...
add_action(
	...
	function() {
		ebox_Settings_Fields_Custom::add_field_instance( 'custom' );
	}
);
