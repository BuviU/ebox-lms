...
if ( ( class_exists( 'ebox_Settings_Fields' ) ) && ( ! class_exists( 'ebox_Settings_Fields_WPEditor' ) ) ) {
	/**
	 * ebox WPEditor Settings Field.
	 *
	 * @since 3.0.0
	 ...
	 */
	class ebox_Settings_Fields_WPEditor extends ebox_Settings_Fields {
...
add_action(
	...
	function() {
		ebox_Settings_Fields_WPEditor::add_field_instance( 'wpeditor' );
	}
);
