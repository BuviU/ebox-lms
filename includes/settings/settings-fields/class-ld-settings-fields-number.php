<?php
/**
 * ebox Input Number Settings Field.
 *
 * @since 3.0.0
...
if ( ( class_exists( 'ebox_Settings_Fields' ) ) && ( ! class_exists( 'ebox_Settings_Fields_Number' ) ) ) {

	/**
	 * Class ebox Input Number Settings Field.
	 *
	 * @since 3.0.0
	 * @uses ebox_Settings_Fields
	 */
	class ebox_Settings_Fields_Number extends ebox_Settings_Fields {
...
add_action(
	...
	function() {
		ebox_Settings_Fields_Number::add_field_instance( 'number' );
	}
);
