<?php
/**
 * ebox Checkbox Switch / Toggle Settings Field.
 *
 * @since 3.0.0
...
if ( ( class_exists( 'ebox_Settings_Fields' ) ) && ( ! class_exists( 'ebox_Settings_Fields_Checkbox_Switch' ) ) ) {

	/**
	 * Class ebox Checkbox Switch / Toggle Settings Field.
	 *
	 * @since 3.0.0
	 * @uses ebox_Settings_Fields
	 */
	class ebox_Settings_Fields_Checkbox_Switch extends ebox_Settings_Fields {
...
add_action(
	...
	function() {
		ebox_Settings_Fields_Checkbox_Switch::add_field_instance( 'checkbox-switch' );
	}
);
