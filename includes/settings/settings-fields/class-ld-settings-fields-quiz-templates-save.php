<?php
/**
 * ebox Quiz / Question Templates Settings Field.
 *
 * @since 3.0.0
...
if ( ( class_exists( 'ebox_Settings_Fields' ) ) && ( ! class_exists( 'ebox_Settings_Fields_Quiz_Templates_Save' ) ) ) {
	/**
	 * Class ebox Quiz / Question Templates Settings Field.
	 *
	 * @since 3.0.0
	 * @uses ebox_Settings_Fields
	 */
	class ebox_Settings_Fields_Quiz_Templates_Save extends ebox_Settings_Fields {
		...
		public function create_section_field( $field_args = array() ) {
			...
			$html .= esc_html__( 'Select a templates to save or new', 'ebox' ) . '</option>';

			$html .= '   <option value="0">=== ' . esc_html__( 'Create new template', 'ebox' ) . ' === </option>';
			...
			$html .= '</select>';
			$html .= '</span><br />';
			$html .= '<input type="text" placeholder="' . esc_html__( 'new template name', 'ebox' ) . '" class="regular-text -medium" name="templateName">';
...
add_action(
	...
	function() {
		ebox_Settings_Fields_Quiz_Templates_Save::add_field_instance( 'quiz-templates-save' );
	}
);
