<?php
/**
 * ebox Input Radio Settings Field.
 *
 * @since 3.0.0
...
if ( ( class_exists( 'ebox_Settings_Fields' ) ) && ( ! class_exists( 'ebox_Settings_Fields_Radio' ) ) ) {

	/**
	 * Class ebox Input Radio Settings Field.
	 *
	 * @since 3.0.0
	 * @uses ebox_Settings_Fields
	 */
	class ebox_Settings_Fields_Radio extends ebox_Settings_Fields {
...
add_action(
	...
	function() {
		ebox_Settings_Fields_Radio::add_field_instance( 'radio' );
	}
);
