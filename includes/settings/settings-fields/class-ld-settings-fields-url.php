...
if ( ( class_exists( 'ebox_Settings_Fields' ) ) && ( ! class_exists( 'ebox_Settings_Fields_URL' ) ) ) {

	/**
	 * Class ebox Input URL Settings Field.
	 *
	 * @since 3.1.0
	 * @uses ebox_Settings_Fields
	 */
	class ebox_Settings_Fields_URL extends ebox_Settings_Fields {
...
add_action(
	...
	function() {
		ebox_Settings_Fields_URL::add_field_instance( 'url' );
	}
);
