...
if ( ( class_exists( 'ebox_Settings_Fields' ) ) && ( ! class_exists( 'ebox_Settings_Fields_Html' ) ) ) {
	/**
	 * Class ebox HTML Settings Field.
	 *
	 * @since 3.0.0
	 * @uses ebox_Settings_Fields
	 */
	class ebox_Settings_Fields_Html extends ebox_Settings_Fields {
		...
		public function create_section_field( $field_args = array() ) {
			 ...
			 */
			$field_type = apply_filters( 'ebox_settings_field_element_html', 'div' );
			$html      .= '<' . $field_type . ' ';
...
add_action(
	...
	function() {
		ebox_Settings_Fields_Html::add_field_instance( 'html' );
	}
);
