...
if ( ( class_exists( 'ebox_Settings_Fields' ) ) && ( ! class_exists( 'ebox_Settings_Fields_Hidden' ) ) ) {
	/**
	 * Class ebox Hidden Settings Field.
	 *
	 * @since 3.0.0
	 * @uses ebox_Settings_Fields
	 */
	class ebox_Settings_Fields_Hidden extends ebox_Settings_Fields {
...
add_action(
	...
	function() {
		ebox_Settings_Fields_Hidden::add_field_instance( 'hidden' );
	}
);
