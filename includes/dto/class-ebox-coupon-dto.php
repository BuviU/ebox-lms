...
if ( ! class_exists( 'ebox_Coupon_DTO' ) && class_exists( 'ebox_DTO' ) ) {
	/**
	 * Coupon DTO class. Used to map the coupon data.
	 *
	 * @since 4.5.0
	 */
	class ebox_Coupon_DTO extends ebox_DTO {
		const VALID_TYPES = array( ebox_COUPON_TYPE_FLAT, ebox_COUPON_TYPE_PERCENTAGE );
