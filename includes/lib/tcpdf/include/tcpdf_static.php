...
class TCPDF_STATIC {
	...
	/**
	 * String alias for total number of pages in a single team.
	 * @public static
	 */
	public static $alias_team_tot_pages = '{:ptg:}';

	/**
	 * String alias for team page number.
	 * @public static
	 */
	public static $alias_team_num_page = '{:png:}';
	...
	* @since 5.9.121 (2011-09-28)
	...
	public static function getAnnotOptFromJSProp($prop, &$spot_colors, $rtl=false) {
		...
		// radiosInUnison: If false, even if a team of radio buttons have the same name and export value, they behave in a mutually exclusive fashion, like HTML radio buttons.
	...
	public static function extractCSSproperties($cssdata) {
		...
		// split teams of selectors (comma-separated list of selectors)
