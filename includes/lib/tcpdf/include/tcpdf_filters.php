...
// -----------------------------------------------------------------------------
	...
	public static function decodeFilterASCII85Decode($data) {
		...
		// position inside a team of 4 bytes (0-3)
		$team_pos = 0;
		$tuple = 0;
		...
		for ($i = 0; $i < $data_length; ++$i) {
			...
			if ($char == 122) { // 'z'
				...
				// the value represented by a team of 5 characters should never be greater than 2^32 - 1
				$tuple += (($char - 33) * $pow85[$team_pos]);
				if ($team_pos == 4) {
