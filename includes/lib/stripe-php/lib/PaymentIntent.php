 ...
 * @property null|string $transfer_team A string that identifies the resulting payment as part of a team. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
 */
