	...
	function enhanced_paypal_shortcode( $atts ) {
		$atts = shortcode_atts(
			array(
				...
				'rm'                             => '2',
				'lc'                             => '',
				'cbt'                            => esc_html__( 'Complete Your Purchase', 'ebox' ),
				'cn'                             => '',
				'pagestyle'                      => 'paypal',
				'notifyurl'                      => '',
				'notifyurl2'                     => '',
				...
				'modify'                         => '',
				'custom'                         => '',
				'button_label'                   => __( 'Use PayPal', 'ebox' ),
			),
			$atts
		);
		...
		<input type="hidden" name="custom" value="' . $atts['custom'] . '">';
				...
				$code .= '<input type="submit" value="' . $button_text . '" class="' . ebox_Payment_Button::map_button_class_name() . '" id="' . ebox_Payment_Button::map_button_id() . '">';
		...
		<input type="image" src="https://www.paypal.com/en_US/i/scr/pixel.gif" border="0" alt="" width="1" height="1" class="ppalholder">';
				...
				if ( $atts['imageurl'] ) {
					...
					$code .= '<input type="hidden" src="https://www.paypal.com/en_AU/i/btn/btn_subscribeCC_LG.gif" border="0" name="submit" alt="' . esc_html__( 'PayPal - The safer, easier way to pay online.', 'ebox' ) . '" class="ppalbtn">';
				}
