...
<div class="wrap">
	...
	<form method="post">
		<div id="poststuff">
			<div class="postbox">
				<h3 class="hndle"><?php esc_html_e( 'Front', 'ebox' ); ?></h3>
		...
		<ol class="wpProQuiz_list">
				...
				<input type="button" name="check" value="Prüfen" class="wpProQuiz_QuestionButton" style="float: left !important; margin-right: 10px;">
				<input type="button" name="back" value="Zurück" class="wpProQuiz_QuestionButton" style="float: left !important; margin-right: 10px; ">
