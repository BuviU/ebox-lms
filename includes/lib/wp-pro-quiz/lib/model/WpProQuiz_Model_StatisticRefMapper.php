...
class WpProQuiz_Model_StatisticRefMapper extends WpProQuiz_Model_Mapper {
	...
	public function fetchSelected( array $args = array() ) {
		...
		$join  = apply_filters( 'ebox_statrefs_joins', '' );
		$where = apply_filters( 'ebox_statrefs_where', ' 1=1 ' );
	...
	public function fetchHistoryWithArgs( $args = array() ) {
		 ...
		 */
		$where = apply_filters( 'ebox_fetch_quiz_statistic_history_where', $where, $args );
	...
	public function countHistory( $quizId, $users = -1, $startTime = 0, $endTime = 0 ) {
		...
		$where = apply_filters( 'ebox_fetch_statistic_form_history_count_where', $where, $users, $users, $startTime, $endTime );
	...
	public function fetchStatisticOverviewWithArgs( $args = array() ) {
		...
		$where = apply_filters( 'ebox_fetch_quiz_statistic_overview_where', $where, $args );
