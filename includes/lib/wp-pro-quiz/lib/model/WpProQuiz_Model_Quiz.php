...
class WpProQuiz_Model_Quiz extends WpProQuiz_Model_Model {
	...
	public function setId( $_id = 0 ) {
		...
		if ( ( empty( $this->_quiz_post_id ) ) && ( ! defined( 'ebox_PROQUIZ_IMPORT' ) ) ) {
			$this->_quiz_post_id = ebox_get_quiz_id_by_pro_quiz_id( $this->_id );
		}
	...
	public function getResultText() {
		...
		$this->_resultText = ebox_quiz_result_message_sort( $this->_resultText );
	...
	public function getViewProfileStatistics() {
		 ...
		 */
		return apply_filters( 'ebox_quiz_default_viewPofileStatistics', $this->_viewPofileStatistics );
	}
