...
class WpProQuiz_Model_GlobalSettingsMapper extends WpProQuiz_Model_Mapper {
	...
	public function getEmailSettings() {
		...
		if ( null === $e ) {
			...
			$e['subject'] = sprintf( esc_html_x( 'ebox %1$s: One user completed a %2$s', 'placeholder: Quiz, quiz', 'ebox' ), ebox_Custom_Label::get_label( 'quiz' ), ebox_get_custom_label_lower( 'quiz' ) );
			$e['html']    = false;
			$e['message'] = sprintf(
				// translators: placeholder: Quiz, quiz.
				esc_html_x(
