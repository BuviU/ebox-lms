...
class ActionScheduler_wcSystemStatus {
	...
	/**
	 * Display action data, including number of actions teamed by status and the oldest & newest action in each status.
	 *
	 ...
	 * @param array $action_counts Number of actions teamed by status.
