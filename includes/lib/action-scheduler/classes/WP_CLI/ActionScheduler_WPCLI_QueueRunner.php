...
class ActionScheduler_WPCLI_QueueRunner extends ActionScheduler_Abstract_QueueRunner {
	 ...
	 * @param string $team      The team of actions to claim with this batch.
	 ...
	 */
	public function setup( $batch_size, $hooks = array(), $team = '', $force = false ) {
		$this->run_cleanup();
		$this->add_hooks();
		...
		$this->claim = $this->store->stake_claim( $batch_size, null, $hooks, $team );
