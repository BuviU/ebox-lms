...
abstract class ActionScheduler_Store extends ActionScheduler_Store_Deprecated {
	 ...
	 *      @type string       $team            The team the action belongs to. Optional.
	 ...
	 *      @type int          $orderby          Accepted values are 'hook', 'team', 'modified', 'date' or 'none'. Defaults to 'date'.
	 ...
	 */
	abstract public function stake_claim( $max_actions = 10, DateTime $before_date = null, $hooks = array(), $team = '' );
