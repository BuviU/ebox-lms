<?php
/**
 * Deprecated. Use ebox_Stripe_Gateway instead.
...
_deprecated_file(
	basename( __FILE__ ),
	'4.5.0',
	esc_html( ebox_LMS_PLUGIN_DIR . '/includes/payments/gateways/class-ebox-stripe-gateway.php' )
);

if ( ! class_exists( 'ebox_Stripe_Connect_Checkout_Integration' ) && class_exists( 'ebox_Payment_Gateway_Integration' ) ) {
	/**
	 ...
	 * @deprecated 4.5.0
	 */
	class ebox_Stripe_Connect_Checkout_Integration extends ebox_Payment_Gateway_Integration {
		/**
		 * Deprecated.
		 *
		 * @deprecated 4.5.0
		...
		public function enqueue_scripts(): void {
			...
			$gateway = ebox_Payment_Gateway::get_active_payment_gateway_by_name( ebox_Stripe_Gateway::get_name() );
		...
		/**
		 * Get ebox course ID by Stripe plan ID.
		 *
		 * @deprecated 4.5.0
		 *
		 * @param string $plan_id Stripe plan ID.
		 *
		 * @return string|null ebox course ID or null.
		 */
		...
		/**
		 * Checks if ebox Stripe Connect webhook is running.
		 *
		 * @deprecated 4.5.0
		 *
		 * @return bool
