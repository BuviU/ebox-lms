<?php
/**
 * Deprecated. Use ebox_Razorpay_Gateway instead.
...
_deprecated_file(
	basename( __FILE__ ),
	'4.5.0',
	esc_html( ebox_LMS_PLUGIN_DIR . '/includes/payments/gateways/class-ebox-razorpay-gateway.php' )
);

if ( ! class_exists( 'ebox_Razorpay_Integration' ) && class_exists( 'ebox_Payment_Gateway_Integration' ) ) {
	/**
	 ...
	 * @deprecated 4.5.0
	 */
	class ebox_Razorpay_Integration extends ebox_Payment_Gateway_Integration {
		/**
		 * Deprecated.
		 *
		 * @deprecated 4.5.0
		 */
		const AJAX_ACTION_SETUP_OPTIONS = 'ebox_razorpay_setup_options';
		 ...
		 * @deprecated 4.5.0
		 */
		const META_KEY_CUSTOMER_ID_LIVE = 'ebox_razorpay_live_customer_id';
		 ...
		 * @deprecated 4.5.0
		 */
		const META_KEY_CUSTOMER_ID_TEST = 'ebox_razorpay_test_customer_id';
		 ...
		 * @deprecated 4.5.0
		 */
		const META_KEY_PLANS_LIVE = 'ebox_razorpay_live_plans';
		 ...
		 * @deprecated 4.5.0
		 */
		const META_KEY_PLANS_TEST = 'ebox_razorpay_test_plans';
		...
		/**
		 * Course/Team we are working with.
		 *
		 * @since 4.2.0
		 * @deprecated 4.5.0
		 *
		...
		public function enqueue_scripts(): void {
			...
			$gateway = ebox_Payment_Gateway::get_active_payment_gateway_by_name( ebox_Razorpay_Gateway::get_name() );
		 ...
		 * @deprecated 4.5.0
		 *
		 * @param string $default_button ebox default payment button.
