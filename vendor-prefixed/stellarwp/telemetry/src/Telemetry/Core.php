...
namespace StellarWP\ebox\StellarWP\Telemetry;

use StellarWP\ebox\StellarWP\ContainerContract\ContainerInterface;
use StellarWP\ebox\StellarWP\Telemetry\Admin\Admin_Subscriber;
use StellarWP\ebox\StellarWP\Telemetry\Admin\Resources;
use StellarWP\ebox\StellarWP\Telemetry\Contracts\Data_Provider;
use StellarWP\ebox\StellarWP\Telemetry\Data_Providers\Debug_Data;
use StellarWP\ebox\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use StellarWP\ebox\StellarWP\Telemetry\Exit_Interview\Template;
use StellarWP\ebox\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use StellarWP\ebox\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use StellarWP\ebox\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use StellarWP\ebox\StellarWP\Telemetry\Opt_In\Status;
use StellarWP\ebox\StellarWP\Telemetry\Telemetry\Telemetry;
use StellarWP\ebox\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \StellarWP\ebox\StellarWP\ContainerContract\ContainerInterface
	 */
