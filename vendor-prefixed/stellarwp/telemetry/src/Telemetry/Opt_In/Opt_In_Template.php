...
namespace StellarWP\ebox\StellarWP\Telemetry\Opt_In;
	...
	protected function get_args() {
		...
		$optin_args['intro'] = sprintf(
			...
			__(
				...
				If you opt-in, some data about your usage of %2$s and future Products will be shared with our peoples (so they can work their butts off to improve).
