...
namespace StellarWP\ebox\StellarWP\Telemetry\Exit_Interview;
...
use StellarWP\ebox\StellarWP\Telemetry\Contracts\Template_Interface;
use StellarWP\ebox\StellarWP\Telemetry\Core;
...
class Template implements Template_Interface {
	 ...
	 * @since 1.0.0
	 *
	 * @var \StellarWP\ebox\StellarWP\ContainerContract\ContainerInterface
	 */
	protected $container;
	 ...
	 * @since 1.0.0
	 *
	 * @param \StellarWP\ebox\StellarWP\ContainerContract\ContainerInterface $container The container.
	 */
