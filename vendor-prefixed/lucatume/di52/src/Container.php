...
use Closure;
use Exception;
use StellarWP\ebox\lucatume\DI52\Builders\BuilderInterface;
use StellarWP\ebox\lucatume\DI52\Builders\ValueBuilder;
...
class Container implements ArrayAccess, ContainerInterface
{
    ...
    /**
     * Checks whether a tag team exists in the container.
     *
     * @param string $tag
     *
     * @return bool
