<?php
/**
 * ebox LD30 Displays content tabs
 *
 * @since 3.0.0
 *
 ...
 */
do_action( 'ebox-content-tabs-before', get_the_ID(), $course_id, $user_id );
 ...
 * @param int       $user_id   User ID.
 */
do_action( 'ebox-' . $context . '-content-tabs-before', get_the_ID(), $course_id, $user_id );

$tab_count = 0;

/**
 * Filters ebox content Tabs.
 *
 * @since 3.0.0
 *
...
$tabs = apply_filters(
	...
	array(
		array(
			...
			'label'   => ebox_Custom_Label::get_label( $context ),
			'content' => $content,
		),
		array(
			'id'        => 'materials',
			'icon'      => 'ld-icon-materials',
			'label'     => __( 'Materials', 'ebox' ),
			'content'   => $materials,
...
<div class="ld-tabs <?php echo esc_attr( 'ld-tab-count-' . $tab_count ); ?>">
	...
	<div class="ld-tabs-content">
		 ...
		 * @param int       $user_id   User ID.
		 */
		do_action( 'ebox-content-tab-listing-before', get_the_ID(), $context, $course_id, $user_id );
		 ...
		 * @param int          $user_id   User ID.
		 */
		do_action( 'ebox-' . $context . '-content-tab-listing-before', get_the_ID(), $course_id, $user_id );
		...
		foreach ( $tabs as $tab ) :
			 ...
			 * @param int       $user_id   User ID.
			 */
			do_action( 'ebox-content-tabs-' . $tab['id'] . '-before', get_the_ID(), $context, $course_id, $user_id );
			?>
			 ...
			 * @param int       $user_id   User ID.
			 */
			do_action( 'ebox-content-tabs-' . $tab['id'] . '-after', get_the_ID(), $context, $course_id, $user_id );
		 ...
		 * @param int       $user_id   User ID.
		 */
		do_action( 'ebox-content-tab-listing-after', get_the_ID(), $course_id, $user_id );
		 ...
		 * @param int          $user_id   User ID.
		 */
		do_action( 'ebox-' . $context . '-content-tab-listing-after', get_the_ID(), $course_id, $user_id );
		?>
 ...
 * @param int       $user_id   User ID.
 */
do_action( 'ebox-content-tabs-after', get_the_ID(), $course_id, $user_id );
 ...
 * @param int       $user_id   User ID.
 */
do_action( 'ebox-' . $context . '-content-tabs-after', get_the_ID(), $course_id, $user_id );
