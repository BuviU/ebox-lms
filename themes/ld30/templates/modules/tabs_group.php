<?php
/**
 * ebox LD30 Displays tabs content for a team
 *
 * @since 3.0.0
 *
...
do_action( 'ebox-content-tabs-before', get_the_ID(), $team_id, $user_id );

/** This filter is documented in themes/ld30/templates/modules/tabs.php */
do_action( 'ebox-' . $context . '-content-tabs-before', get_the_ID(), $team_id, $user_id );
...
<div class="ld-tabs <?php echo esc_attr( 'ld-tab-count-' . $tab_count ); ?>">
	...
	<div class="ld-tabs-content">
		<?php
		/** This filter is documented in themes/ld30/templates/modules/tabs.php */
		do_action( 'ebox-content-tab-listing-before', get_the_ID(), $context, $team_id, $user_id );

		/** This filter is documented in themes/ld30/templates/modules/tabs.php */
		do_action( 'ebox-' . $context . '-content-tab-listing-before', get_the_ID(), $team_id, $user_id );
		...
		foreach ( $tabs as $tab ) :
			...
			/** This filter is documented in themes/ld30/templates/modules/tabs.php */
			do_action( 'ebox-content-tabs-' . $tab['id'] . '-before', get_the_ID(), $context, $team_id, $user_id );
			?>
			...
			<?php
			/** This filter is documented in themes/ld30/templates/modules/tabs.php */
			do_action( 'ebox-content-tabs-' . $tab['id'] . '-after', get_the_ID(), $context, $team_id, $user_id );

			$i++;
		endforeach;

		/** This filter is documented in themes/ld30/templates/modules/tabs.php */
		do_action( 'ebox-content-tab-listing-after', get_the_ID(), $team_id, $user_id );

		/** This filter is documented in themes/ld30/templates/modules/tabs.php */
		do_action( 'ebox-' . $context . '-content-tab-listing-after', get_the_ID(), $team_id, $user_id );
		?>
...
<?php
/** This filter is documented in themes/ld30/templates/modules/tabs.php */
do_action( 'ebox-content-tabs-after', get_the_ID(), $team_id, $user_id );

/** This filter is documented in themes/ld30/templates/modules/tabs.php */
do_action( 'ebox-' . $context . '-content-tabs-after', get_the_ID(), $team_id, $user_id );
