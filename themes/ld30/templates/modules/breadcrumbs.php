<?php
/**
 * ebox LD30 Displays the breadcrumbs
 *
 * Available Variables:
 *
 ...
 * @since 3.0.0
 */
do_action( 'ebox-breadcrumbs-before' ); ?>

<div class="ld-breadcrumbs-segments">
	<?php
	$breadcrumbs = ebox_get_breadcrumbs( $post );
 ...
 * @since 3.0.0
 */
do_action( 'ebox-breadcrumbs-after' ); ?>
