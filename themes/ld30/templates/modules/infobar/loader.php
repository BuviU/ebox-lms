<?php
/**
 * ebox LD30 Displays an informational bar
 *
 ...
 */
do_action( 'ebox-all-infobar-before', get_post_type(), $user_id );

ebox_get_template_part( 'infobar', get_post_type() );
 ...
 * @param int          $user_id   User ID.
 */
do_action( 'ebox-all-infobar-after', get_post_type(), $user_id );
