<?php
/**
 * ebox LD30 Displays a custom alert message
 *
...
/**
 * Filters ebox custom alert message text.
 *
 * @since 3.0.0
 *
...
if ( ( isset( $message ) ) && ( ! empty( $message ) ) ) :
	 ...
	 * @param string $type    Alert message type.
	 */
	do_action( 'ebox-alert-before', $class, $icon, $message, $type ); ?>
	...
	<div class="<?php echo esc_attr( $class ); ?>">
		<div class="ld-alert-content">
			 ...
			 * @param string $type    Alert message type.
			 */
			do_action( 'ebox-alert-icon-before', $class, $icon, $message, $type );
			 ...
			 * @param string $type    Alert message type.
			 */
			do_action( 'ebox-alert-icon-after', $class, $icon, $message, $type );
			 ...
			 * @param string $type    Alert message type.
			 */
			do_action( 'ebox-alert-message-after', $class, $icon, $message, $type );
			?>
		</div>
		 ...
		 * @param string $type    Alert message type.
		 */
		do_action( 'ebox-alert-between-message-button', $class, $icon, $message, $type );
		 ...
		 * @param string $type    Alert message type.
		 */
		do_action( 'ebox-alert-content-after', $class, $icon, $message, $type );
		?>
	</div>
	 ...
	 * @param string $type    Alert message type.
	 */
	do_action( 'ebox-alert-after', $class, $icon, $message, $type );
