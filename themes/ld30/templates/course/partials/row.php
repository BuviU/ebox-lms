<?php
/**
 * ebox LD30 Displays the listing of course row
 *
 * @since 3.0.0
 *
 ...
 */
$course_class = apply_filters( 'ebox-course-list-shortcode-course-class', '' ); ?>
 ...
 */
do_action( 'ebox-course-row-before', $course_id, $user_id );
?>
...
<div id="course-<?php echo esc_attr( $user_id ) . '-' . esc_attr( $course->ID ); ?>" class="<?php echo esc_attr( $course_class ); ?>">
	<div>
		 ...
		 * @param int $user_id   User ID.
		 */
		do_action( 'ebox-course-row-status-before', $course_id, $user_id );
		?>
		 ...
		 * @param int $user_id   User ID.
		 */
		do_action( 'ebox-course-row-link-before', $course_id, $user_id );
		?>
		 ...
		 * @param int $user_id   User ID.
		 */
		do_action( 'ebox-course-row-certificate-before', $course_id, $user_id );
		?>
		 ...
		 * @param int $user_id   User ID.
		 */
		do_action( 'ebox-course-row-expand-before', $course_id, $user_id );
		?>
		 ...
		 * @param int $user_id   User ID.
		 */
		do_action( 'ebox-course-row-expand-after', $course_id, $user_id );
		?>
