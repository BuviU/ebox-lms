 ...
 */
do_action( 'ebox-before-section-heading', $section, $course_id, $user_id ); ?>
<div class="ld-item-list-section-heading ld-item-section-heading-<?php echo esc_attr( $section->ID ); ?>">
	 ...
	 * @param int     $user_id   User ID.
	 */
	do_action( 'ebox-before-inner-section-heading', $section, $course_id, $user_id );
	?>
	 ...
	 * @param int     $user_id   User ID.
	 */
	do_action( 'ebox-after-inner-section-heading', $section, $course_id, $user_id );
	?>
</div>
<?php
/**
 ...
 * @param int     $user_id   User ID.
 */
do_action( 'ebox-after-section-heading', $section, $course_id, $user_id );
