<?php
/**
 * ebox LD30 Displays quiz data for user in ld_profile shortcode
 *
 * Available Variables:
...
foreach ( $quizzes as $k => $v ) :
	...
	if ( ! $quiz instanceof WP_Post || 'ebox-quiz' !== $quiz->post_type ) {
	...
	if ( ! empty( $quiz_title ) ) : ?>
		...
		<div class="ld-item-list-item">
			<a class="ld-item-list-item-preview" href="<?php echo esc_url( ebox_get_step_permalink( $quiz->ID, $course_id ) ); ?>">
