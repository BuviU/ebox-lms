<?php
/**
 * ebox LD30 Displays course information for a user
 *
 * Available:
 * $user_id
		...
		if ( 'profile.php' !== $pagenow && 'user-edit.php' !== $pagenow && $courses_registered ) :
			...
			<div class="ld-course-info-courses">
				...
				echo sprintf(
					...
					esc_html_x( 'You are registered for the following %s', 'placeholder: courses', 'ebox' ),
			...
			<?php
			echo ebox_LMS::get_template( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Outputting an HTML template
				'ebox_pager.php',
				array(
