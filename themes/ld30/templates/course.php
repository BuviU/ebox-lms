...
$has_lesson_quizzes = ebox_30_has_lesson_quizzes( $course_id, $modules ); ?>
...
<div class="<?php echo esc_attr( ebox_the_wrapper_class() ); ?>">
	 ...
	 */
	do_action( 'ebox-course-before', get_the_ID(), $course_id, $user_id );
	 ...
	 * @param int $user_id   User ID.
	 */
	do_action( 'ebox-course-certificate-link-before', $course_id, $user_id );
	...
	if ( ( defined( 'ebox_TEMPLATE_CONTENT_METHOD' ) ) && ( 'shortcode' === ebox_TEMPLATE_CONTENT_METHOD ) ) {
		$shown_content_key = 'ebox-shortcode-wrap-ld_certificate-' . absint( $course_id ) . '_' . absint( $user_id );
	 ...
	 * @param int $user_id   User ID.
	 */
	do_action( 'ebox-course-certificate-link-after', $course_id, $user_id );
	 ...
	 */
	$show_course_content = ( ! $has_access && 'on' === $course_meta['ebox-courses_course_disable_content_table'] ? false : true );
		...
		if ( ( defined( 'ebox_TEMPLATE_CONTENT_METHOD' ) ) && ( 'shortcode' === ebox_TEMPLATE_CONTENT_METHOD ) ) {
			...
			<div class="ld-item-list ld-lesson-list">
				<div class="ld-section-heading">
					 ...
					 * @param int $user_id   User ID.
					 */
					do_action( 'ebox-course-heading-before', $course_id, $user_id );
					?>
					 ...
					 * @param int $user_id   User ID.
					 */
					do_action( 'ebox-course-heading-after', $course_id, $user_id );
					?>
					...
					<div class="ld-item-list-actions" data-ld-expand-list="true">
						 ...
						 * @param int $user_id   User ID.
						 */
						do_action( 'ebox-course-expand-before', $course_id, $user_id );
						?>
						...
						if ( $has_topics || $has_lesson_quizzes ) :
							?>
							<div class="ld-expand-button ld-primary-background" id="<?php echo esc_attr( 'ld-expand-button-' . $course_id ); ?>" data-ld-expands="<?php echo esc_attr( 'ld-item-list-' . $course_id ); ?>" data-ld-expand-text="<?php echo esc_attr_e( 'Expand All', 'ebox' ); ?>" data-ld-collapse-text="<?php echo esc_attr_e( 'Collapse All', 'ebox' ); ?>">
						 ...
						 * @param int $user_id   User ID.
						 */
						do_action( 'ebox-course-expand-after', $course_id, $user_id );
						?>
				 ...
				 * @param int $user_id   User ID.
				 */
				do_action( 'ebox-course-content-list-before', $course_id, $user_id );
				 ...
				 * @param int $user_id   User ID.
				 */
				do_action( 'ebox-course-content-list-after', $course_id, $user_id );
				?>
	 ...
	 * @param int $user_id   User ID.
	 */
	do_action( 'ebox-course-after', get_the_ID(), $course_id, $user_id );
