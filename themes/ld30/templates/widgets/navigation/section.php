<?php
/**
 * ebox LD30 Displays the course navigation widget section.
 *
 * @since 3.0.0
 *
 ...
 */
do_action( 'ebox-nav-before-section-heading', $section, $course_id, $user_id ); ?>
<div class="ld-lesson-item-section-heading ld-lesson-item-section-heading-<?php echo esc_attr( $section->ID ); ?>">
	 ...
	 * @param int     $user_id   User ID.
	 */
	do_action( 'ebox-nav-before-inner-section-heading', $section, $course_id, $user_id );
	?>
	 ...
	 * @param int     $user_id   User ID.
	 */
	do_action( 'ebox-nav-after-inner-section-heading', $section, $course_id, $user_id );
	?>
</div>
<?php
/**
 ...
 * @param int     $user_id   User ID.
 */
do_action( 'ebox-nav-after-section-heading', $section, $course_id, $user_id );
