<?php
/**
 * ebox LD30 Displays the course navigation widget row.
 *
 * @since 3.0.0
 *
...
if ( ! empty( $modules ) ) :
	...
	foreach ( $modules as $course_lesson ) :
		...
		$all_topics = ebox_topic_dots( $course_lesson['post']->ID, false, 'array' );
		...
		$lesson_topics = ebox_process_lesson_topics_pager( $all_topics, $topic_pager_args );
