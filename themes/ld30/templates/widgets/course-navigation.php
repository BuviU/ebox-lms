<?php
/**
 * ebox LD30 Displays the course navigation widget.
 *
 * @since 3.0.0
 *
...
$has_topics         = ebox_30_has_topics( $course_id, $modules );
		...
		<div class="ld-course-navigation-heading">
			<div class="ld-course-navigation-actions">
				<a class="ld-home-link" href="<?php echo esc_url( get_permalink( $course->ID ) ); ?>"><?php printf( // phpcs:ignore Squiz.PHP.EmbeddedPhp.ContentBeforeOpen,Squiz.PHP.EmbeddedPhp.ContentAfterOpen
					...
					esc_html_x( '%s Home', 'Course Navigation Home Label', 'ebox' ),
				...
				<?php if ( $has_lesson_quizzes || $has_topics ) : ?>
					<span class="ld-expand-button ld-button-alternate" data-ld-expands="<?php echo esc_attr( 'ld-lesson-list-' . $course->ID ); ?>"  data-ld-expand-text="<?php esc_html_e( 'Expand All', 'ebox' ); ?>" data-ld-collapse-text="<?php esc_html_e( 'Collapse All', 'ebox' ); ?>">
						<span class="ld-icon-arrow-down ld-icon ld-primary-background"></span>
						<span class="ld-text ld-primary-color"><?php esc_html_e( 'Expand All', 'ebox' ); ?></span>
					</span>
				<?php endif; ?>
