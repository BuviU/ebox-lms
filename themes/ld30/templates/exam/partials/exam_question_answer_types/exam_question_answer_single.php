...
$ebox_answer_content .= '<input type="radio" id="ld-exam-question-answer-' . $ebox_question_model->question_idx . '-' . $ebox_question_answer['answer_idx'] . '" name="ld-exam-question-answer[' . $ebox_question_model->question_idx . ']" value="' . $ebox_question_answer['answer_idx'] . '" ' . $ebox_input_checked . ' ' . $ebox_input_disabled . '/>';
