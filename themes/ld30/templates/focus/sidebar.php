...
do_action( 'ebox-focus-sidebar-before', $course_id, $user_id ); ?>
...
<div class="ld-focus-sidebar">
	<div class="ld-course-navigation-heading">
		 ...
		 */
		do_action( 'ebox-focus-sidebar-trigger-wrapper-before', $course_id, $user_id );
		?>
		...
		<span class="ld-focus-sidebar-trigger">
			 ...
			 * @param int $user_id   User ID.
			 */
			do_action( 'ebox-focus-sidebar-trigger-before', $course_id, $user_id );
			?>
			<span class="ld-icon <?php echo esc_attr( ebox_30_get_focus_mode_sidebar_arrow_class() ); ?>"></span>
			<?php
			/**
			 ...
			 * @param int $user_id   User ID.
			 */
			do_action( 'ebox-focus-sidebar-trigger-after', $course_id, $user_id );
			?>
		</span>
		 ...
		 * @param int $user_id   User ID.
		 */
		do_action( 'ebox-focus-sidebar-trigger-wrapper-after', $course_id, $user_id );
		?>
		 ...
		 * @param int $user_id   User ID.
		 */
		do_action( 'ebox-focus-sidebar-heading-before', $course_id, $user_id );
		?>
		 ...
		 * @param int $user_id   User ID.
		 */
		do_action( 'ebox-focus-sidebar-heading-after', $course_id, $user_id );
		?>
	</div>
	<div class="ld-focus-sidebar-wrapper">
		 ...
		 * @param int $user_id   User ID.
		 */
		do_action( 'ebox-focus-sidebar-between-heading-navigation', $course_id, $user_id );
		?>
			...
			<div class="ld-course-navigation-list">
				<div class="ld-lesson-navigation">
					<div class="ld-lesson-items" id="<?php echo esc_attr( 'ld-lesson-list-' . $course_id ); ?>">
						 ...
						 * @param int $user_id   User ID.
						 */
						do_action( 'ebox-focus-sidebar-nav-before', $course_id, $user_id );

						$modules = ebox_get_course_modules_list( $course_id, $user_id, ebox_focus_mode_lesson_query_args( $course_id ) );
						 ...
						 * @param int $user_id   User ID.
						 */
						do_action( 'ebox-focus-sidebar-nav-after', $course_id, $user_id );
						?>
					</div> <!--/.ld-lesson-items-->
		 ...
		 * @param int $user_id   User ID.
		 */
		do_action( 'ebox-focus-sidebar-after-nav-wrapper', $course_id, $user_id );
		?>
 ...
 * @param int $user_id   User ID.
 */
do_action( 'ebox-focus-sidebar-after', $course_id, $user_id );
?>
