...
jQuery(function () {
  if (jQuery(".ebox_timer").length) {
    jQuery(".ebox_timer").each(function (idx, item) {
...
jQuery(function () {
  if (typeof ebox_data !== "undefined") {
    if (typeof ebox_data.json !== "undefined") {
      ...
      ebox_data = JSON.parse(ebox_data);
    }
  }

  jQuery("#ld_course_info").on(
    "click",
    "a.user_statistic",
    ebox_show_user_statistic
  );
  jQuery("#ebox_profile").on(
    "click",
    "a.user_statistic",
    ebox_show_user_statistic
  );

  function ebox_show_user_statistic(e) {
    e.preventDefault();
