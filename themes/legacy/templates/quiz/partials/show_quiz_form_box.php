...
$info = '<div class="wpProQuiz_invalidate">' . esc_html__( 'You must fill out this field.', 'ebox' ) . '</div>';

$validateText = array(
	WpProQuiz_Model_Form::FORM_TYPE_NUMBER => esc_html__( 'You must specify a number.', 'ebox' ),
	WpProQuiz_Model_Form::FORM_TYPE_TEXT   => esc_html__( 'You must specify a text.', 'ebox' ),
	WpProQuiz_Model_Form::FORM_TYPE_EMAIL  => esc_html__( 'You must specify an email address.', 'ebox' ),
	WpProQuiz_Model_Form::FORM_TYPE_DATE   => esc_html__( 'You must specify a date.', 'ebox' ),
);
?>
			...
			<tr>
				...
				<td>
					...
					if ( isset( $validate_array[ $form->getType() ] ) ) {
						...
						echo '<div class="wpProQuiz_invalidate">' . esc_html__( 'You must fill out this field.', 'ebox' ) . '</div>';
					}
					?>
				</td>
			</tr>
